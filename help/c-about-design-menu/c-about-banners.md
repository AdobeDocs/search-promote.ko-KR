...
첫 번째 방법은 Target, Search&amp;Promote를 통해 배너를 추가하는 것입니다. 배너는 고객이 웹 사이트를 검색할 때 표시되는 HTML 코드 조각입니다. 배너에는 GIF, JPEG 또는 PNG 형식의 텍스트 또는 이미지가 포함되거나 두 가지 유형이 함께 포함될 수 있습니다. 사전 설정 크기 중에서 선택하거나 페이지에 맞게 사용자 정의 차원을 정의할 수 있습니다. 배너를 표시하는 데 사용하는 HTML 코드에서도 사용할 글꼴 스타일 및 테두리와 같은 요소를 지정할 수 있습니다. 배너를 추가하는 이 방법은 기본 기능을 제공하며 추가 소프트웨어가 필요하지 않습니다.

두 번째 방법은 다이내믹 미디어 관리 및 게시 서비스인 Adobe Dynamic Media Classic을 사용하는 것입니다. 유효한 Adobe Dynamic Media Classic 계정을 사용하면 Dynamic Media Classic을 사용하여 배너 컨텐츠를 관리하고 Target, Search&amp;Promote에 바로 제공할 수 있습니다. 사이트 검색/머천다이징에서 Dynamic Media Classic 계정에 대한 액세스 권한을 구성합니다. Dynamic Media Classic 미디어 브라우저를 열고 배너로 사용할 다이내믹 미디어 자산을 선택합니다.

>[!NOTE]
>
>다이내믹 미디어 자산을 사이트 검색/머천다이징에서 배너로 사용하려면 먼저 자산이 업로드되고 Scene7 Publishing System에 게시될 준비가 됩니다. 사이트 검색/머천다이징 내에서 자산을 업로드하고 Scene7 Publishing System에서 게시할 수 있도록 자동으로 준비하도록 할 수 있습니다. 또는 Scene7 Publishing System 내에서 자산을 모두 업로드하고 게시할 수 있습니다.

## Adobe Scene7 Publishing System과 배너 통합 {#section_D4D7ADEA6A6348E68EDA138E184FE579}

Dynamic Media Classic 에셋 유형을 이미지, 동적 배너, 이미지 템플릿 또는 Flash 템플릿과 같은 템플릿 등 사이트 검색/머천다이징에서 배너로 사용할 수 있습니다.

템플릿은 Adobe Photoshop®과 같은 이미지 편집 애플리케이션에서 레이어로 구성된 파일과 같은 레이어로 구성된 이미지 파일을 동적으로 만들고 주소 지정할 수 있는 레이어로 구성된 이미지 파일로 만들어집니다. 정적 이미지 파일과 달리 템플릿에는 매개 변수가 포함될 수 있습니다. 매개 변수를 통해 변수 이미지 속성과 이미지 컨텐츠를 사용자 정의할 수 있습니다.
...
템플릿에는 원하는 수의 이미지 레이어와 텍스트 레이어가 포함될 수 있습니다. 레이어가 포함된 정적 파일(예: 레이어로 구성된 PSD 파일)을 템플릿으로 변환하거나 Dynamic Media Classic에서 템플릿을 만들 수 있습니다. Scene7 Publishing System에 업로드한 글꼴을 사용하여 템플릿에서 텍스트 레이어를 만들 수 있습니다. 템플릿에 텍스트를 추가한 후 정렬, 글꼴, 글꼴 크기 및 색상을 변경하여 서식을 지정할 수 있습니다.

Dynamic Media Classic의 [매개 변수] 화면에서 템플릿의 모든 측면을 주소 지정 가능한 매개 변수로 변환할 수 있습니다. 이렇게 하면 템플릿에 사용할 레이어 이미지 또는 사용할 텍스트 값을 변경할 수 있습니다. 매개 변수는 URL 문자열과 함께 전달되므로 이미지 서버에서 생성된 응답 이미지를 동적으로 사용자 정의할 수 있도록 매개 변수를 변경할 수 있습니다.

Dynamic Media Classic을 사용하여 템플릿을 만들고 레이어에서 속성을 매개 변수화하는 방법에 대한 자세한 내용을 배너에서 사용할 수 있습니다.
...
사이트 검색/머천다이징의 배너에 자산을 사용하려면 먼저 Dynamic Media Classic에서 자산을 업로드하고 게시해야 합니다. 이 사전 요구 사항에는 이미지 템플릿 또는 Flash 템플릿에서 사용하는 모든 에셋도 포함되어 있습니다. Dynamic Media Classic 계정을 사용하여 디지털 자산을 업로드하고 게시합니다. 또는 사이트 검색/머천다이징을 사용하여 디지털 자산을 업로드한 다음 Dynamic Media Classic에서 업로드 설정에 따라 자동으로 게시하도록 할 수 있습니다. 아직 업로드 및 게시되지 않은 자산을 선택하려고 하면, 계속하기 전에 사용자 인터페이스에서 알림을 받고 업로드할 수 있습니다.

Scene7 Publishing System을 사용하여 디지털 자산을 업로드하고 게시하는 방법에 대해 자세히 알아볼 수 있습니다.

Dynamic [Media Classic](https://help.adobe.com/en_US/scene7/using/WS3673AD39-098B-4f08-8A24-CA51261B7366.html) (Scene7) 사용 안내서의 자산 업로드 및 게시를 참조하십시오.

>[!NOTE]
>
>Dynamic Media Classic 자산 뷰어에서 업로드 기능을 사용하려면 사용하는 Dynamic Media Classic 계정에 &quot;SPS 회사 관리&quot; 역할이 이미 설정되어 있는지 확인하십시오.
...
Dynamic Media Classic 에셋을 배너로 추가한 경우 에서 [!DNL Visual Rule Builder] 해당 에셋을 사용하여 웹 사이트의 배너 영역에 추가할 [!DNL Business Rules] 수 있습니다. 예를 들어 다른 배너와 마찬가지로 검색 결과 페이지에 배너를 추가합니다. Dynamic Media Classic 템플릿에서 기본 매개 변수 값을 사용자 정의하여 재정의할 수도 있습니다. 이러한 종류의 기능을 사용하면 다른 마케팅 메시지와 다른 엔드포인트에 대한 하이퍼링크를 사용하여 Dynamic Media Classic 템플릿을 사용자 지정할 수 있습니다.

새 [비즈니스 규칙](../c-about-rules-menu/c-about-business-rules.md#task_BD3B31ED48BB4B1B8F1DCD3BFA2528E7)추가를 참조하십시오.

비즈니스 [규칙](../c-about-rules-menu/c-about-business-rules.md#task_375CFA75D1D94D9E92A35DE1228E5087)편집을 참조하십시오.

## 배너 추가 {#task_549D02B5F73B4158B105A94E39D937B7}

를 [!DNL Banners] 사용하여 배너 광고와 배너 광고가 웹 사이트에 배치되는 위치를 관리할 수 있습니다. 배너를 추가하면 검색 시 표시되는 HTML 코드 조각을 통해 외부에서 이미지를 참조합니다.
...
Adobe [Dynamic Media Classic 계정에](../c-about-settings-menu/c-about-account-options-menu.md#task_CEFF88C2033D41D0B2FE86C435EDAC6D)대한 액세스 권한 구성을 참조하십시오.

**배너를 추가하려면**

1. 제품 메뉴에서 **[!UICONTROL Design]** > **[!UICONTROL Banners]**&#x200B;을 클릭합니다.
1. 페이지의 [!DNL Banners] 드롭다운 목록에서 **[!UICONTROL Add Banner]** **[!UICONTROL HTML code]**&#x200B;선택합니다.
1. 대화 [!DNL Add Banner] 상자에서 원하는 옵션을 설정합니다.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>필수. 배너의 이름을 식별합니다. 비즈니스 규칙의 시각적 규칙 빌더에서 배너를 추가할 때 배너를 참조하는 데 이름이 사용됩니다. 이름이 배너 자체에 표시되지 않습니다. </p> <p>새 <a href="../c-about-rules-menu/c-about-business-rules.md#task_BD3B31ED48BB4B1B8F1DCD3BFA2528E7" type="task" format="dita" scope="local"> 비즈니스 규칙 추가를 참조하십시오.</a> </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>배너 HTML </p> </td> 
      <td colname="col2"> <p> 배너와 연결된 HTML 코드를 붙여넣을 수 있습니다. </p> <p>모든 HTML 코드는 
        <userinput>
          &lt;style&gt; 
        </userinput> 태그 또는 
        <userinput>
          &lt;script&gt; 
        </userinput> 태그가 있는 세그먼트만 필터링할 수 있습니다. 예를 들어, 다음 코드 블록은 Horizontal top :다음 <code> &lt;div&nbsp;style="width:&nbsp;684px;&nbsp;background-image:&nbsp;url('https://www.brough.com/blackb.gif');&nbsp; 
          padding-top:&nbsp;10px;&nbsp;padding-bottom:&nbsp;10px;&nbsp;color:&nbsp;white;&nbsp;font-family:&nbsp;verdana;&nbsp; 
          text-align:&nbsp;center;&nbsp;font-size:&nbsp;20px;"&gt;&nbsp;Sound&nbsp;Study&nbsp;ships&nbsp;free!&nbsp;&lt;/div&gt; </code>예에서 코드 블록은 전체 시작 이미지를 위한 것입니다. <code> &lt;img&amp;nbsp;src='https://geometrixx.com/images/GEOAds/geometrixx-beauty-home-01.jpg'&amp;nbsp;border="0"&amp;nbsp;/&gt; </code> </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>다음 유형의 배너를 지정합니다. 
        <ul id="ul_6423AEDB9E664049989EB529D63C4A62"> 
          ...
          <li id="li_1A29AB22AD644E60A12298187B5E898E"> <span class="uicontrol"> 전체 시작 </span> <p>이 유형의 배너는 가로 680픽셀, 세로 650픽셀입니다. 선택적으로 유형 이름을 지정하거나 배너 유형 자체의 이름인 기본 이름을 사용할 수 있습니다. </p> </li> 
          <li id="li_2BE06D013CB54DDE851051BFC038BB57"> <span class="uicontrol"> 가로 상단 </span> <p> 배너는 웹 사이트의 상단 영역에 배치됩니다. 이 유형은 배너의 왼쪽 또는 오른쪽에 하이퍼링크를 추가하려는 경우에 유용합니다. 이 유형의 배너는 가로 468픽셀, 세로 60픽셀입니다. 선택적으로 유형 이름을 지정하거나 배너 유형 자체의 이름인 기본 이름을 사용할 수 있습니다. </p> </li> 
          <li id="li_EC35AB92234749F08AA8A9BD26D0EA8D"> <span class="uicontrol"> 가로 위쪽 - 전체 너비 </span> <p>이 유형은 새 배너를 추가할 때의 기본값입니다. 배너는 웹 사이트의 상단 영역에 배치되며 페이지의 전체 너비를 차지합니다. 이 유형의 배너는 가로 670픽셀, 세로 150픽셀입니다. 선택적으로 유형 이름을 지정하거나 배너 유형 자체의 이름인 기본 이름을 사용할 수 있습니다. </p> </li> 
        </ul> </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>태그 </p> </td> 
      <td colname="col2"> <p>배너와 연결할 태그 또는 "키워드"를 추가합니다. 배너를 많이 사용하는 경우 태그를 추가하면 배너 검색을 조정할 수 있으므로 필요한 배너만 신속하게 찾을 수 있습니다. 추가한 태그를 삭제할 수도 있습니다. </p> </td> 
      </tr> 
    </tbody> 
    </table>
...
배너 이름, 배너 HTML, 배너 유형 및 모든 관련 태그와 같은 사항을 변경하는 [!DNL Edit Banner] 데 사용합니다.
...
사이트 검색/머천다이징을 사용하여 배너를 추가한 경우 Adobe Dynamic Media Classic을 사용하여 배너도 편집합니다.
...
1. 페이지에서 원하는 옵션을 [!DNL Edit Banner] 설정합니다.
   ...
   배너 [](../c-about-design-menu/c-about-banners.md#task_549D02B5F73B4158B105A94E39D937B7)추가 아래의 옵션 표를 참조하십시오.
...
를 [!DNL Banners] 사용하여 웹 사이트의 배너 광고를 관리할 수 있습니다. Adobe Dynamic Media Classic을 사용하여 배너를 추가하는 경우 Scene7 Publishing System에 업로드한 모든 디지털 자산 중에서 선택할 수 있습니다.
...
1. 페이지의 [!DNL Banners] 드롭다운 목록에서 을 **[!UICONTROL Add Banner]** **[!UICONTROL Adobe Scene7]**&#x200B;클릭합니다.
1. 왼쪽 창의 [!DNL Pick an Asset] 대화 상자에서 사용자 인터페이스의 탐색 옵션을 사용하여 배너에 사용할 디지털 자산이 들어 있는 폴더를 찾습니다.
   ...
   >[!NOTE]
   >
   >대화 상자에서 배너를 편집할 때 자산 탐색 옵션이 나타나지 않습니다. [!DNL Change Parameters]
   ...
   **자산 탐색 옵션**
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>드롭다운 목록에서 특정 회사에 대한 Dynamic Media Classic 계정을 선택하고 해당 계정 내에서 디지털 자산 폴더를 탐색할 수 있습니다. </p> <p>폴더를 선택하면 [자산 선택] 대화 <span class="wintitle"> 상자의 오른쪽 창에 해당 폴더 내에 포함된 사용 가능한 모든 디지털 </span> 자산이 표시됩니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> <img src="assets/s7_folderhistory.png"> </p> </td> 
      <td colname="col2"> <p>폴더 탐색 내역을 지나 뒤로 이동할 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> <img src="assets/s7_reloadfolder.png"> </p> </td> 
      <td colname="col2"> <p>선택한 폴더에 대해 표시되는 디지털 자산 목록을 새로 고칩니다. </p> <p>작업 드롭다운 목록을 사용하여 선택한 자산을 이동, 삭제 또는 이름을 변경하는 경우 이 컨트롤을 클릭해야 <span class="uicontrol"> 할 </span> 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>데스크탑이나 <span class="wintitle"> 외부 서버에서 선택한 디지털 자산을 업로드하여 배너로 사용할 수 있는 업로드 </span> 대화 상자를 엽니다. </p> <p>자산을 업로드하면 Scene7 Publishing System에서 게시 작업이 자동으로 예약됩니다. </p> <p>Adobe Dynamic Media Classic을 사용하여 배너 <a href="../c-about-design-menu/c-about-banners.md#task_AD1E0C00A9E04B1FA819EB93288786B3" type="reference" format="dita" scope="local"> 추가의 옵션 표를 </a>참조하십시오. </p> <p>Scene7 Publishing System을 사용하여 디지털 자산을 업로드하고 게시하는 방법에 대해 자세히 알아볼 수 있습니다. </p> <p>Scene7 <a href="https://help.adobe.com/en_US/scene7/using/WS3673AD39-098B-4f08-8A24-CA51261B7366.html" scope="external" format="html"> Publishing System </a> 사용 안내서의 자산 업로드 및 게시를 참조하십시오. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>다른 자산 필터를 추가하면 표시되는 디지털 자산 목록을 유형이나 특정 날짜별로 더 세분화할 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> <img src="assets/s7_Kindfilter.png"> </p> </td> 
      <td colname="col2"> <p>표시된 디지털 자산 목록을 세분화하여 Flash, 이미지, 템플릿 또는 임의 등과 같은 특정 유형의 디지털 자산만 표시합니다. </p> <p>을 <img src="assets/s7_deletefilter.png"> 클릭하여 검색에서 필터를 삭제합니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> <img src="assets/s7_datefilter.png"> </p> </td> 
      <td colname="col2"> <p>표시된 디지털 자산 목록을 세분화하여 특정 날짜 이전 또는 특정 날짜 이후에 만들거나 편집한 것만 표시합니다. </p> <p>을 <img src="assets/s7_deletefilter.png" /> 클릭하여 검색에서 필터를 삭제합니다. </p> </td> 
      </tr> 
      <tr> 
   ...
   **속성 옵션**
   ...
   Flash 템플릿, 이미지 템플릿 또는 이미지를 선택한 경우 속성 옵션이 나타납니다. 선택한 디지털 자산에 따라 일부 옵션을 사용할 수 있는 것은 아닙니다.
   ...
   <table> 
    ...
    <tbody> 
      <tr> 
      <td colname="col1"> <p>이름 </p> </td> 
      <td colname="col2"> <p>빈 공간 없이 템플릿 또는 이미지의 설명형 이름입니다. 선택적으로 이름에 이미지 크기 사양을 포함시켜 사용자가 자산을 추가로 식별할 수 있도록 할 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>JPEG 또는 GIF 형식 이미지의 압축 수준을 제어합니다. 이 설정은 파일 크기와 이미지 품질 모두에 영향을 줍니다. 품질 척도는 1-100입니다. </p> <p>슬라이더를 왼쪽 또는 오른쪽으로 드래그하면 품질 변화에 따라 미리 보기 창의 이미지가 업데이트됩니다. </p> <p>이 옵션은 Flash 템플릿에 적용되지 않습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>너비 </p> </td> 
      <td colname="col2"> <p>디지털 자산의 너비를 픽셀 단위로 지정합니다. 이 차원은 웹 사이트를 방문하는 고객이 자산을 보는 너비입니다. </p> <p>이 옵션은 Flash 템플릿에 적용되지 않습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>높이 </p> </td> 
      <td colname="col2"> <p>디지털 자산의 높이를 픽셀 단위로 지정합니다. 이 차원은 웹 사이트를 방문하는 고객이 자산을 보는 높이입니다. </p> <p>이 옵션은 Flash 템플릿에 적용되지 않습니다. </p> </td> 
      </tr> 
    </tbody> 
    </table>
   ...
   **배너 링크 옵션**
   ...
   배너 링크 옵션은 배너용 이미지 또는 이미지 템플릿을 선택한 경우에만 표시됩니다.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>고객이 이미지를 클릭할 때 배너가 연결되도록 할 URL 주소를 지정합니다. </p> <p>배너가 어떤 것에도 연결되지 않도록 하려면 [링크 URL] 필드를 비워 두십시오. </p> </td> 
      </tr> 
      <tr> 
   ...
   **링크 수정 옵션**
   ...
   링크 수정 옵션은 배너용 Flash 템플릿을 선택한 경우에만 나타납니다.
   ...
   **텍스트 바꾸기 옵션**
   ...
   >[!NOTE]
   >
   >검색 및 바꾸기 명령을 추가하여 &quot;cow&quot;를 &quot;apple&quot;으로 바꾼 다음 두 번째 명령을 만들어 &quot;apple&quot;을 &quot;orange&quot;로 바꾸면 두 번째 명령은 영향을 받지 않습니다.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>검색할 텍스트 대신 삽입할 텍스트를 지정할 수 있습니다. </p> <p>이 <span class="uicontrol"> 필드에서 Enter 키를 누르면 </span> 미리 보기 창이 대체 텍스트로 업데이트됩니다. </p> </td> 
      </tr> 
    </tbody> 
    </table>
   ...
   **매개 변수 옵션**
   ...
   매개 변수 옵션은 배너용 이미지 템플릿 또는 Flash 템플릿을 선택한 경우에만 나타납니다. 실제 매개 변수 옵션은 Scene7 Publishing System에서 템플릿을 만들고 매개 변수화한 방법에 따라 달라집니다. 예를 들어, 서식 파일은 텍스트, 글꼴 스타일, 가격, 무료 배송에 사용되는 특수 코드, 배너 내의 이미지 크기 또는 다른 이미지를 검색할 수 있도록 해주는 매개 변수화된 필드를 사용할 수 있습니다.

   >[!NOTE]
   >
   >매개 변수에 대한 모든 변경 사항은 비즈니스 규칙으로 재정의할 수 있습니다. 비즈니스 규칙이 만들어지지 않으면 매개 변수를 변경하는 경우에만 매개 변수가 기본값으로 사용됩니다.
   ...
   **레이어 가시성 전환 옵션**
   ...
   [레이어 가시성 전환] 옵션은 배너용 Flash 템플릿을 선택한 경우에만 적용됩니다.
   ...
   **기본 옵션**
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p> 업로드, 게시 및 배너로 사용할 파일을 찾을 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> 덮어쓰기 </p> </td> 
      <td colname="col2"> <p>업로드한 파일은 선택한 폴더 내에서 기존 파일을 동일한 파일 이름으로 바꿉니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>이메일 기본 설정 </p> </td> 
      <td colname="col2"> <p> 업로드할 이메일 알림을 선택하거나 업로드 작업과 관련된 알림을 받지 않도록 선택할 수 있습니다. </p> </td> 
      </tr> 
    </tbody> 
    </table>
   ...
   **고급 옵션**
   ...
   PostScript(EPS) 또는 Illustrator(AI 파섹) 이미지 파일을 업로드할 때 다양한 방법으로 형식을 지정할 수 있습니다. 파일을 래스터화하고, 템플릿 게시를 위한 FXG로 변환하고, 투명한 배경을 유지하고, 해상도를 선택하고, 색상 공간을 선택할 수 있습니다.
   ...
   파일을 사용하여 템플릿을 만드는 경우 Scene7 Publishing System은 레이어가 있는 PSD 파일에서 여러 이미지를 만듭니다.각 레이어에 대해 하나의 이미지를 만듭니다.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p> 다음 옵션 중에서 선택할 수 있습니다. </p> 
        ...
        <li id="li_CA3F44FF9C0F4CE987DCB0AF9303C2E4"> <span class="uicontrol"> SRGB로 변환 </span> <p>SRGB(Standard Red Green Blue)로 변환합니다. SRGB는 웹 페이지에 이미지를 표시하기 위한 권장 색상 공간입니다. </p> </li> 
      ...
      <td colname="col2"> <p> <span class="uicontrol"> 래스터화 </span> 옵션을 사용하면 파일의 벡터 그래픽을 비트맵 포맷으로 변환할 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> Postscript 옵션 </p> <p>Illustrator 옵션 </p> </td> 
      ...
      <td colname="col2"> <p>Illustrator 파일의 색상 공간을 선택할 수 있습니다. RGB 색상 공간은 온라인 보기용으로 선호됩니다. </p> <p>다음 색상 공간 옵션 중에서 선택할 수 있습니다. </p> 
        <ul id="ul_0E83E2762A574480B243F963A7FB2ACD"> 
        <li id="li_B9FEC7D220D04CCABACD30839051DAE4"> <span class="uicontrol"> 자동으로 검색 </span> <p> PDF 파일의 색상 공간을 유지합니다. </p> </li> 
      ...
      <td colname="col2"> <p>PSD의 레이어(있는 경우)를 개별 에셋으로 리핑합니다. 에셋 레이어는 PSD와 연결된 상태로 유지됩니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p> Photoshop 옵션 </p> </td> 
      ...
      <td colname="col2"> <p>리핑된 이미지 레이어의 크기를 배경 레이어 크기로 확장합니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>Photoshop 옵션 </p> </td> 
      <td colname="col02"> <p> 레이어 이름 지정 </p> </td> 
      <td colname="col2"> <p>PSD 파일의 레이어는 별도의 이미지로 업로드됩니다. 다음 옵션 중에서 선택하여 Scene7 Publishing System에서 이러한 이미지의 이름을 지정하는 방법을 결정할 수 있습니다. </p> 
        <ul id="ul_C2A25177A07740CA90B32C638304D39F"> 
        <li id="li_477D5BFF7238454BBF0E04B22DE378F7"> <span class="uicontrol"> PSD 파일의 레이어 이름 사용 </span> <p>PSD 파일에서 이미지 이름을 레이어 이름 다음에 지정합니다. 예를 들어 원본 PSD <span class="codeph"> 파일의 Price Tag </span> 라는 레이어는 Price Tag라는 <span class="codeph"> 이미지가 됩니다 </span>. 그러나 PSD 파일의 레이어 이름이 기본 Photoshop 레이어 이름(배경, 레이어 1, 레이어 2 등)인 경우 이미지는 기본 레이어 이름이 아니라 PSD 파일에서 레이어 번호의 이름을 따릅니다. </p> </li> 
        <li id="li_EB4173B884FC41328CFBDE27DA6D43AA"> <span class="uicontrol"> PSD 파일 이름 및 첨부 번호 사용 </span> <p>원본 레이어 이름은 무시하고 PSD 파일에서 레이어 번호 다음에 이미지 이름을 지정합니다. 이미지 이름은 Photoshop 파일 이름과 추가된 레이어 번호로 지정됩니다. 예를 들어 Spring Ad.psd라는 파일의 두 번째 레이어는 Photoshop에서 <span class="codeph"> 기본값이 아닌 이름을 </span> 가진 경우에도 Spring Ad_2 <span class="codeph"> 로 명명됩니다 </span> . </p> </li> 
        <li id="li_10B2D2DE2FD24BD08DB56D1D95ABA53D"> <span class="uicontrol"> PSD 파일 이름 및 레이어 이름 또는 번호 사용 </span> <p>PSD 파일 다음에 레이어 이름 또는 레이어 번호가 나오는 이미지 이름을 지정합니다. 레이어 번호는 PSD 파일의 레이어 이름이 기본 Photoshop 레이어 이름인 경우에 사용됩니다. 예를 들어 SpringAd라는 PSD 파일의 <span class="codeph"> Price Tag라는 레이어를 Spring </span> Ad_Price <span class="codeph"> Tag </span> 라고 <span class="codeph"> 합니다 </span>. 기본 이름이 Layer <span class="codeph"> 2인 레이어는 Spring Ad_2 </span><span class="codeph"> 로 </span>지정됩니다. </p> </li> 
      ...
      <td colname="col2"> <p>PSD 파일에서 생성된 레이어로 구성된 컴포지션에서 생성된 템플릿에 이미지를 고정시키는 방법을 지정합니다. </p> <p>기본적으로 앵커는 가운데입니다. 가운데 앵커를 사용하면 교체 이미지의 종횡비에 상관없이 대체 이미지가 동일한 공간을 가장 잘 채울 수 있습니다. 템플릿을 참조하고 매개 변수 대체를 사용할 때 이 이미지를 대체하는 다른 측면을 가진 이미지가 동일한 공간을 효과적으로 차지합니다. 애플리케이션에서 템플릿의 할당된 공간을 채우려면 대체 이미지가 필요한 경우 다른 설정으로 변경합니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col1"> <p>PDF 옵션 </p> </td> 
      <td colname="col02"> <p> 색상 공간 </p> </td> 
      <td colname="col2"> <p>PDF 파일의 색상 공간을 선택할 수 있습니다. 대부분의 PDF 파일에는 RGB 및 CMYK 색상 이미지가 모두 있습니다. RGB 색상 공간은 온라인 보기용으로 선호됩니다. </p> <p>다음 색상 공간 옵션 중에서 선택할 수 있습니다. </p> 
        <ul id="ul_44A8C39DEB21473F9375E3962F14D3C6"> 
        <li id="li_1046FA0017934C5EB7C0100F8F78507D"> <span class="uicontrol"> 자동으로 검색 </span> <p> PDF 파일의 색상 공간을 유지합니다. </p> </li> 
      ...
      <tr> 
      <td colname="col1"> <p>PDF 옵션 </p> </td> 
      <td colname="col02"> <p>여러 페이지 PDF에서 eCatalog 자동 생성 </p> </td> 
...
Adobe [!DNL Edit Banner] Dynamic Media Classic을 사용하여 추가한 배너의 속성 및 매개 변수를 변경하는 데 사용합니다.
...
배너 [편집을](../c-about-design-menu/c-about-banners.md#task_D4081083BE7B40F5A003D1A2F1435AEA)참조하십시오.

**Adobe Dynamic Media Classic을 사용하여 배너를 편집하려면**

1. 제품 메뉴에서 **[!UICONTROL Design]** > **[!UICONTROL Banners]**&#x200B;을 클릭합니다.
1. 페이지에서 배너 창의 왼쪽 아래에 S7 아이콘이 있는 배너 축소판 [!DNL Banners] ![](assets/icon_edit_16.gif) 위를 클릭합니다.
...
더 이상 필요 없거나 한 번에 하나씩 또는 그룹으로 사용하려는 스테이지된 배너를 삭제할 수 있습니다.
...
1. (선택 사항) 다음 중 하나 이상을 수행합니다.
   ...
   * 페이지의 [!DNL Banners] **[!UICONTROL Find banner of type]** 드롭다운 목록에서 찾을 배너 유형을 선택합니다. 원하는 경우 **[!UICONTROL with tag]** 텍스트 필드에 태그 이름을 지정하거나 **[!UICONTROL with name]** 텍스트 필드에 배너 유형 이름을 지정합니다. 클릭 **[!UICONTROL Find.]**

   * 드롭다운 목록에서 배너 목록을 정렬하는 방법을 선택합니다. **[!UICONTROL Sort]**
   * 드롭다운 **[!UICONTROL Show]** 목록에서 현재 보고 있는 페이지로 로드할 배너의 수를 선택합니다.

1. 다음 중 하나를 수행하십시오.

   * 배너 상자의 왼쪽 위 모서리에서 삭제할 각 배너의 확인란을 클릭합니다.
   * 페이지의 상단 막대에서 현재 표시된 페이지에 로드되는 모든 배너를 [!DNL Banners] **[!UICONTROL Select all]** 선택합니다.
...
페이지에 추가한 배너를 검색하여 전체 크기를 볼 수 있습니다. [!DNL Banners] 배너에 영향을 주는 템플릿의 CSS는 표시되지 않습니다.
...
1. 페이지에서 배너 축소판을 클릭하여 전체 크기를 봅니다. [!DNL Banners]
1. 다음 중 하나를 수행하십시오.
...
또는 원하는 경우 페이지 하단에 있는 **[!UICONTROL Push Live]** 옵션을 사용하여 배너에 대한 모든 변경 사항을 실시간으로 푸시할 수 [!DNL Banners] 있습니다.
...
1. 다음 중 하나를 수행하십시오.
   ...
   * 배너 상자의 왼쪽 위 모서리에서 삭제할 각 배너의 확인란을 클릭합니다.
   * 페이지의 상단 막대에서 현재 표시된 페이지에 로드되는 모든 배너를 [!DNL Banner] **[!UICONTROL Select all]** 선택합니다.

1. 드롭다운 **[!UICONTROL Bulk Actions]** 목록에서 을 클릭합니다 **[!UICONTROL Push live]**.
1. 대화 [!DNL Confirmation Action] 상자에서 을 클릭합니다 **[!UICONTROL OK]**.
1. (선택 사항) [!DNL Banners] 페이지에서 아이콘을 클릭하여 변경한 내용을 되돌립니다 **[!UICONTROL History]** .
