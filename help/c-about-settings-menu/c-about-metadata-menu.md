...
고객이 검색 쿼리 [!DNL Definitions] 를 제출할 때 고려되는 HTML 및 메타데이터 필드의 컨텐츠 및 연관성을 사용자 지정하는 데 사용할 수 있습니다.

이미 사전 정의된 필드를 편집할 수 있습니다. 또는 메타데이터 태그 컨텐츠를 기반으로 새로운 사용자 정의 필드를 만들 수도 있습니다. 각 정의는 [!DNL Staged Definitions] 페이지의 한 줄에 표시됩니다.

데이터 보기 [정보도 참조하십시오](../c-about-reports-menu/c-about-data-views.md#concept_DCA897D074464BC1861AA47B40CC86C3).

## 새 메타 태그 필드 추가 {#task_6DF188C0FC7F4831A4444CA9AFA615E5}

고유한 메타데이터 태그 필드를 정의하고 추가할 수 있습니다.

새 메타 태그 정의의 효과가 고객에게 표시되기 전에 사이트 색인을 다시 구성해야 합니다.

**새 메타 태그 필드를 추가하려면**

1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Definitions]**&#x200B;클릭합니다.
...
1. 페이지에서 원하는 옵션을 [!DNL Add Field] 설정합니다.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <li id="li_E55404D6CE354EC89CFFEB1048A11F44"> 단계 정의 페이지의 표에 표시된 대로 사전 정의된 필드에 존재하는 이름은 사용할 수 <span class="wintitle"> </span> 없습니다. </li> 
      <li id="li_7CE328AE3B5F45A8A09E2DA7ECB62551"> "any"라는 단어는 사용자 정의 필드 이름의 값으로 사용할 수 없습니다. </li> 
      ...
      <ul id="ul_5881669913D04E35A6D4A6D31BEE7DF3"> 
        ...
        <li id="li_6D1BEB3D19AC499E9227EC115AEB6296"> 아주 야생적인 </li> 
      </ul> </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>모든 필드에는 텍스트, 번호, 날짜, 버전, 등급 또는 위치와 같은 관련 데이터 유형이 있습니다. 이 데이터 유형은 필드의 컨텐츠가 인덱싱되고, 검색되고, 선택적으로 정렬되는 방법을 결정합니다. </p> <p>필드 정의를 만든 후에는 데이터 유형을 변경할 수 없습니다. </p> <p>다음 정보를 사용하여 필드가 포함하는 정보와 관련된 데이터 유형을 선택할 수 있습니다. </p> <p> 
      ...
      <li id="li_BB68CB1DBE0543AC9000B3DEDFB28E7E"> <span class="uicontrol"> 버전 </span> 데이터 유형 필드는 자유형 숫자 데이터로 처리됩니다. 예를 들어 1.2.3은 1.2.2 이전에 정렬합니다. </li> 
      ...
      <li id="li_5283A2F2D5D84840B3D920C08D43654C"> DDD 또는 DDDD-DDD 형식의 5 또는 9자리 우편 번호. 여기서 각 "D"는 0-9자리입니다. </li> 
      <li id="li_A5CD4DFC90164BC68183DB7D10603B7C"> DD 형식의 3자리 영역 코드. </li> 
      <li id="li_9DAEAE64BC7F4902B25043D998C8F56D"> DD.DDD DDD DDD.DDD 형식의 위도/경도 쌍입니다. 여기서 첫 번째 숫자는 위도를, 두 번째 숫자는 경도를 지정합니다. </li> 
      </ul> </p> </li> 
      </ul> </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>주어진 필드를 지정된 테이블 이름과 영구적으로 연결합니다. </p> <p>코어 검색 CGI 매개 변수 또는 템플릿 태그 내에서 이러한 필드가 언급될 때마다 테이블 이름이 자동으로 제공됩니다. 이 기능을 사용하면 테이블 일치를 통한 동적 패싯을 선택할 수 있지만 원하는 경우 비동적 패싯 필드에 사용할 수도 있습니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>이 옵션을 선택하면 해당 검색 쿼리에 필드가 명시적으로 지정되지 않은 경우에도 필드 컨텐츠가 검색됩니다. 이 옵션을 선택 해제하면 필드가 요청 시 검색됩니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>수직 업데이트 필드 </p> </td> 
      <td colname="col2"> <p> <p>참고: 이 기능은 기본적으로 활성화되어 있지 않습니다. 기술 지원 센터에 연락하여 활성화를 참조하십시오. 활성화되면 사용자 인터페이스에 표시됩니다. </p> </p> <p>식별된 필드를 수직 업데이트 필드로 설정합니다. </p> <p>수직 업데이트 필드는 수직 업데이트 프로세스( 색인 <span class="uicontrol"> &gt; </span> 수직 업데이트 <span class="uicontrol"> </span>)를 통해 업데이트할 후보자입니다. 수직 업데이트가 이루어지는 방식 때문에 이러한 필드의 내용을 자유 텍스트 검색에서 검색할 수 없습니다. 이 옵션을 선택하면 색인 작업 중 이 필드의 내용이 "word" 색인에 추가되지 않습니다. 또한 세로 업데이트 작업 중에 이 필드를 업데이트할 수 있습니다. </p> <p>수직 업데이트에 대한 자세한 내용은 수직 업데이트 <a href="../c-about-index-menu/c-about-vertical-updates.md#concept_E65A70C9C2E04804BF24FBE1B3CAD899" format="dita" scope="local"> 정보를 참조하십시오 </a>. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>연관성 </p> </td> 
      <td colname="col2"> <p>사전 정의된 필드와 사용자 정의 필드의 연관성을 편집할 수 있습니다. </p> <p>관련성은 1-10의 척도에서 지정됩니다. 1을 설정하는 것은 관련성이 가장 낮으며 가장 관련성이 높은 10을 의미합니다. 이 값들은 소프트웨어가 각 필드에서 쿼리와 일치하는 것으로 간주할 때 고려됩니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>데이터 유형 등급, 숫자 <span class="uicontrol"> 또는 날짜 </span>를 선택한 경우에만 사용할 수 <span class="uicontrol"> </span><span class="uicontrol"> </span> 있습니다. </p> <p>이 필드의 날짜, 번호 및 등급 값을 인덱싱할 때 적용되는 언어 및 로케일 규칙을 제어합니다. </p> <p>계정 언어를 적용하도록 선택할 수 있습니다(언어 &gt; 단어 및 언어). 또는 각 번호 또는 날짜 값이 포함된 문서와 연결된 언어 또는 특정 언어를 적용할 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>날짜 형식 </p> </td> 
      <td colname="col2"> <p>데이터 유형 날짜 <span class="uicontrol"> 를 선택한 경우에만 사용할 수 </span> 있습니다. </p> <p>이 필드에 대한 날짜 값을 인덱싱할 때 인식되는 날짜 형식을 제어합니다. </p> <p>각 날짜 필드에 대해 날짜 형식 문자열의 기본 목록이 제공됩니다. 목록에 추가하거나 사이트의 요구에 맞게 목록을 편집할 수 있습니다. </p> <p>날짜 <a href="../c-appendices/r-date-formats.md#reference_4D1FC1F6B9F44857967188496D8D335B" type="reference" format="dita" scope="local"> 형식을 참조하십시오 </a>. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>테스트 날짜 형식 </p> </td> 
      <td colname="col2"> <p>데이터 유형 날짜 <span class="uicontrol"> 를 데이터 유형 </span> 으로 선택한 경우에만 사용할 수 있습니다. </p> <p>지정한 날짜 형식을 미리 보고 형식이 올바르게 지정되었는지 확인할 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>시간대 </p> </td> 
      <td colname="col2"> <p>데이터 유형 날짜 <span class="uicontrol"> 를 데이터 유형 </span> 으로 선택한 경우에만 사용할 수 있습니다. </p> <p>시간대를 지정하지 않는 이 필드에 대한 날짜 값을 인덱싱할 때 적용되는 예상 시간대를 제어합니다. </p> <p>예를 들어 계정 시간대가 "미국/로스앤젤레스"로 설정되어 있고 계정 시간대 <span class="uicontrol"> 사용을 선택하면 지정된 표준 시간대가 없는 다음 메타 날짜 값 </span>은 태평양 시간대처럼 취급되어 일광 절약 시간이 계산됩니다. </p> <p>&lt;meta name="dc.date" content="월, 2012년 9월 5일:12:00"&gt; </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>데이터 유형 등급 <span class="uicontrol"> 이 데이터 유형 </span> 으로 선택된 경우에만 사용할 수 있습니다. </p> <p>문서에 이 등급 필드에 대해 정의된 메타 태그가 포함되어 있지 않을 경우 사용되는 등급 값을 제어합니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>가장 중요한 등급 값 </p> </td> 
      <td colname="col2"> <p>데이터 유형 등급 <span class="uicontrol"> 이 데이터 유형 </span> 으로 선택된 경우에만 사용할 수 있습니다. </p> <p>문서의 최대 등급을 나타내는 등급 값을 제어합니다. </p> <p>문서 등급 범위가 0에서 가장 낮은 등급에 10까지 변경되면 이 값을 10으로 설정합니다. </p> <p>문서 순위 범위가 가장 높은 등급에 대해 1에서 가장 낮은 등급에 대해 10까지 변경되면 이 값을 1로 설정합니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택한 경우에만 사용할 수 </span> 있습니다. </p> <p>현재 필드에 대한 범위 설명으로 업데이트할 <span class="uicontrol"> 텍스트 </span> 필드. 이 목록에는 필드 범위 생성을 위해 다른 필드와 함께 아직 사용되고 있지 않은 모든 <span class="uicontrol"> 텍스트 </span> 필드가 포함되어 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>범위 값 </p> </td> 
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택하고 범위 필드 </span> <span class="uicontrol"> </span> 항목을 선택한 경우에만 사용할 수 있습니다. </p> <p>필드 범위 설명을 만들 때 사용할 데이터 포인트가 공백으로 구분됩니다. 예: </p> <code> 10&amp;nbsp;20&amp;nbsp;50&amp;nbsp;100&amp;nbsp;1000 </code> <p>이러한 값을 원하는 순서대로 입력할 수 있습니다. 값이 저장되기 전에 값이 정렬되고 중복됩니다. 음수와 정수가 아닌 값을 지정할 수도 있습니다. </p> <p>이 필드의 각 값에 대해 다음을 수행합니다. 
      <ul id="ul_C4B41AF5AADF4B84B9C489CE82FF7075"> 
      <li id="li_90736394A5AE4F5CA6B47687BCB627AA">값이 범위 값에서 가장 작은 값보다 작으면 <span class="uicontrol"> "보다 작음" 형식 </span><span class="uicontrol"> </span> 이 사용됩니다 </li> 
      <li id="li_A5C272B2D26A468CA07EB2046B2EA8A7">값이 범위 값에서 가장 큰 값보다 크거나 같은 경우 <span class="uicontrol"> "보다 큼" 형식 </span>이 <span class="uicontrol"> </span> 사용됩니다. </li> 
      <li id="li_9DDFB70E1E824CF4819C57450C1A6DD2">그렇지 않으면 필드 값이 두 개의 연속 <span class="uicontrol"> 범위 값 </span> (보다 큼(&gt;) 사이에 있고 보다 작음(&lt;=) 보다 작거나 같음)에 속하는 "range"가 발견되고 <span class="uicontrol"> 중간 형식이 </span> 사용됩니다. </li> 
    </ul> </p> <p>예를 들어 위의 예제 값 세트는 값에 대한 설명 집합을 정의합니다. 
    <ul id="ul_03ED30D5A19346AB8E6809BDD186A9A9"> 
      <li id="li_F97A6B3763954EFE9B6751F472AF7D20">10보다 작음 </li> 
      ...
      </ul> </p> <p>보다 큼 <span class="uicontrol"> 을 사용하여 테스트를 참조하십시오. </span> to change how these tests are performed. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택하고 범위 필드 </span> <span class="uicontrol"> </span> 항목을 선택한 경우에만 사용할 수 있습니다. </p> <p>소수점 오른쪽의 숫자 수를 지정하는 정수 값. 이렇게 하면 라운딩 작업도 제어할 수 있습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>선행 0을 분리하시겠습니까? </p> </td> 
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택한 경우에만 사용할 수 </span> 있습니다. <span class="uicontrol"> 범위 필드 </span> 항목이 선택되고 0이 아닌 정밀도 <span class="uicontrol"> 값이 </span> 설정되었습니다. </p> <p>"0.50"을 ".50"으로 표시해야 합니까? </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>후행 0을 제거할까요? </p> </td> 
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택한 경우에만 사용할 수 </span> 있습니다. <span class="uicontrol"> 범위 필드 </span> 항목이 선택되고 0이 아닌 정밀도 <span class="uicontrol"> 값이 </span> 설정되었습니다. </p> <p>"10.00"을 "10"으로 표시해야 합니까? </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>수천 개의 구분자를 보여주시겠습니까? </p> </td> 
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택하고 범위 필드 </span> <span class="uicontrol"> </span> 항목을 선택한 경우에만 사용할 수 있습니다. </p> <p>"1000"을 "10,000"으로 표시해야 합니까? 로케일별 값이 사용됩니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>제로 값을 조정하시겠습니까? </p> </td> 
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택하고 범위 필드 </span> <span class="uicontrol"> </span> 항목을 선택한 경우에만 사용할 수 있습니다. </p> <p>반올림된 제로 값이 표시되면 [ <span class="uicontrol"> 정밀도] 설정에 따라 반올림하거나 축소해야 </span> 합니까? 예: "0.01"을 표시하시겠습니까? </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>보다 큼 </p> </td> 
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택하고 범위 필드 </span> <span class="uicontrol"> </span> 항목을 선택한 경우에만 사용할 수 있습니다. </p> <p>각 값이 <span class="uicontrol"> 내림차순으로 </span>처리된 범위 값 <i><b></b></i> 의 값과 비교되므로, 기본적으로 이 테스트가 성공되면 중지되는 보다 큼 또는 같음(&gt;=) 연산자를 사용하여 비교됩니다. 이것은 범위 값 세트가 "10 20 50 100 1000" <span class="uicontrol"> </span> 과 같은 경우 값 100은 100에서 1000까지이고, 100은 실제로 100보다 작음을 의미합니다. 50에서 100 사이의 값을 유지하려면 이 옵션을 선택하면 비교 시 보다 큼(&gt;) 연산자를 대신 사용할 수 있습니다. </p> <p>예를 들어, 이 옵션을 선택하면 이 필드의 값 각각에 대해 다음을 수행합니다. 
      <ul id="ul_969621B1BD914FA5BD73ED21F8841010"> 
      <li id="li_157BEFDA7D0E44C481F4E4BC9046EF24">값이 <span class="uicontrol"> 범위 값에서 가장 작은 값(&lt;=)보다 작거나 같은 경우 </span>"보다 작음" 형식 <span class="uicontrol"> </span> 이 사용됩니다 </li> 
      <li id="li_737EE666CA6243A8864E17A311CF3ACC">값이 범위 값에서 가장 큰 값(&gt;)보다 큰 <span class="uicontrol"> 경우 </span>"보다 큼" 형식 <span class="uicontrol"> </span> 이 사용됩니다 </li> 
      <li id="li_353A9820F7F74CCCBB3281EC4CB48734">그렇지 않으면 필드 값이 두 개의 연속 <span class="uicontrol"> 범위 값 </span> (보다 크거나 같음(&gt;=) 더 작은 값과 작음(&lt;) 더 큰 값) 사이에 있는 범위 <span class="uicontrol"> 가 발견되고 중간 형식이 </span> 사용됩니다 </li> 
    </ul> </p> <p>and when checked: 
    <ul id="ul_945844C33C2E4D95A598C4876E15F211"> 
      <li id="li_653B6E2934574DA3B4BCEF07D0A84527">값이 범위 값에서 가장 작은 값보다 작으면 <span class="uicontrol"> "보다 작음" 형식 </span><span class="uicontrol"> </span> 이 사용됩니다 </li> 
      <li id="li_AECA6880002F40FAB1820B37237550A7">값이 범위 값에서 가장 큰 값(&gt;=)보다 크거나 같은 경우 <span class="uicontrol"> "보다 큼" 형식 </span>이 <span class="uicontrol"> </span> 사용됩니다 </li> 
      <li id="li_ECB2DF7CA592497298E9ADC708220366">그렇지 않으면 필드 값이 두 개의 연속 <span class="uicontrol"> 범위 값 </span> (보다 큼(&gt;)보다 작고 큰 값(&lt;=)보다 작거나 같은 값 사이에 있는 범위 <span class="uicontrol"> 가 발견되고 중간 형식이 </span> 사용됩니다 </li> 
      </ul> </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>테스트 </p> </td> 
      <td colname="col2"> <p>범위 설명 <span class="uicontrol"> 만들기를 선택하고 범위 필드 </span> <span class="uicontrol"> </span> 항목을 선택한 경우에만 사용할 수 있습니다. </p> <p>샘플 숫자 값을 제공하고 <span class="uicontrol"> 테스트 </span> 단추를 눌러 범위 필드를 만드는 방법을 확인합니다. 생성된 범위 설명이 창에 표시됩니다. </p> </td> 
      </tr> 
    </tbody> 
    </table>
...
## 사전 정의된 메타 태그 필드 또는 사용자 정의 메타 태그 필드 편집 {#task_0A7657B63596421BB6DB3ED44F827AB3}

사전 정의된 메타 태그의 특정 필드만 편집하거나 사용자가 정의한 메타 태그의 모든 필드를 편집할 수 있습니다.

메타 태그 변경 사항이 고객에게 표시되기 전에 사이트 색인을 다시 구성해야 합니다.

**사전 정의된 메타 태그 필드 또는 사용자 정의 메타 태그 필드를 편집하려면**

1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Definitions]**&#x200B;클릭합니다.
1. 페이지의 표 [!DNL Definitions] 의 [!DNL Actions] 열에서 **[!UICONTROL Edit]** 변경할 메타 태그 필드 이름의 행을 클릭합니다.
...
1. 페이지에서 원하는 옵션을 [!DNL Edit Field] 설정합니다.
   ...
   새 메타 태그 필드 [추가 아래의 옵션 표를 참조하십시오](../c-about-settings-menu/c-about-metadata-menu.md#task_6DF188C0FC7F4831A4444CA9AFA615E5).
...
사전 [정의된 메타 태그 필드 또는 사용자 정의 메타 태그 필드 편집을 참조하십시오](../c-about-settings-menu/c-about-metadata-menu.md#task_0A7657B63596421BB6DB3ED44F827AB3).

고객이 삭제 메타 태그의 효과를 볼 수 있으려면 먼저 사이트 색인을 다시 구성해야 합니다.

**사용자 정의 메타 태그 필드를 삭제하려면**

1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Definitions]**&#x200B;클릭합니다.
1. 페이지의 [!DNL Definitions] 표 [!DNL User-defined fields] 섹션에서 제거할 메타 태그 필드 이름 행 **[!UICONTROL Delete]** 을 클릭합니다.
...
## 주사제 {#concept_DA091920671948A0A893A26B3A2FAAE5}

페이지 자체 [!DNL Injections] 를 편집하지 않고도 웹 페이지에 컨텐츠를 삽입할 수 있습니다.
...
선택적으로 **[!UICONTROL Test]** 페이지 [!DNL Staged Injections] 에서 사용할 수 있습니다. 테스트 필드 이름(예: &quot;제목&quot; 또는 &quot;본문&quot;), 원래 필드 값(예: &quot;홈 페이지&quot;) 및 웹 사이트의 테스트 URL을 입력합니다. 참조에 대한 결과 값이 표시됩니다. 테스트 중에는 현재 값이 변경되지 않습니다.
...
The `append|replace`, `field`, `URL`. 및 `value` 항목은 필수입니다. 라인당 하나의 삽입 정의를 입력합니다. 다음 예에는 6개의 다른 삽입 정의가 포함되어 있습니다.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>필드 이름은 필수입니다. 다음은 사용할 수 있는 10개의 미리 정의된 필드 이름입니다. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>URL이 필요하며 주입되는 문서를 지정합니다. </p> <p>URL은 다음 중 하나입니다. </p> <p> 
     <ul id="ul_C5C74F6D5EA943B293742989EB822751"> 
      ...
      <li id="li_EA2BD0FB66A44CD0844613316F6174D4"> 부분 경로(https://www.mydomain.com/products과 같음) </li> 
      <li id="li_D5E0D6D897C8493ABBFC65517CD4A7DB"> https://www.mydomain.com/*.html에서와 같이 와일드카드를 사용하는 URL </li> 
     </ul> </p> <p>URL 값에 공백 문자가 있으면 안 됩니다. regexp <span class="codeph"></span> 옵션을 사용하는 경우 URL은 정규 표현식으로 처리됩니다. </p> </td> 
  </tr> 
  <tr> 
...
크롤링 및 [색인화할 컨텐츠 유형 선택도 참조하십시오](../c-about-settings-menu/c-about-crawling-menu.md#task_CCAC5C67C8BF4AB7B79D34A1495D5EE8).

## 필드 삽입 정의 추가 {#task_E86566FA1FF74CF68115C0ADA05172AE}

페이지 자체 [!DNL Injections] 를 편집하지 않고도 웹 페이지에 컨텐츠를 삽입할 수 있습니다.

선택적으로 **[!UICONTROL Test]** 페이지 [!DNL Injections] 에서 사용할 수 있습니다. 테스트 필드 이름(예: &quot;제목&quot; 또는 &quot;본문&quot;), 원래 필드 값(예: &quot;홈 페이지&quot;) 및 웹 사이트의 테스트 URL을 입력합니다. 참조에 대한 결과 값이 표시됩니다. 테스트 중에는 현재 값이 변경되지 않습니다.

**필드 삽입 정의를 추가하려면**

1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Injections]**&#x200B;클릭합니다.
1. (선택 사항) [!DNL Injections] 페이지의 [!DNL Test Field Injections] 영역에 테스트 필드, 테스트 원래 값 및 테스트 URL을 입력한 다음 을 클릭합니다 **[!UICONTROL Test]**.
1. 필드에 [!DNL Field Injection Definitions] 라인당 하나의 삽입 정의를 입력합니다.
1. 클릭 **[!UICONTROL Save Changes]**.
...
추가 입력 소스 [!DNL Attribute Loader] 를 정의하여 웹 사이트에서 크롤된 데이터를 늘릴 수 있습니다.
...
속성 로더 정의를 페이지에 추가한 후 이름 값 및 유형 값을 제외한 모든 구성 설정을 변경할 수 있습니다. [!DNL Staged Attribute Loader Definitions]
...
여러 속성 [로더 구성 정보를 참조하십시오.](../c-about-settings-menu/c-about-metadata-menu.md#section_4CC49C74EF294608A184E233F215ADFF)

속성 [을 추가할 때 미리 보기 사용 정보도 참조하십시오..](../c-about-settings-menu/c-about-metadata-menu.md#section_E9CAB000A94C4D9189786C1EDB1CDB46)
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>텍스트 <span class="uicontrol"> </span>의 경우, 줄바꿈 구분 텍스트 줄이 개별 문서에 해당하며, 쉼표나 탭과 같은 지정된 구분 기호를 사용하여 구문 분석됩니다. </p> <p>피드 <span class="uicontrol"> 의 경우 </span>각 문서의 데이터는 다음 양식의 정규 표현식 패턴을 사용하여 추출됩니다. </p> <p> <code class="syntax js"> &lt;${Itemtag}&gt;(.*?)&lt;/${Itemtag}&gt; </code> </p> <p>속성 로더 추가 페이지 <span class="uicontrol"></span><span class="wintitle"> 의 </span> 맵을 사용하여 캐시된 데이터 복사본을 만든 다음 크롤러에 대한 링크 목록을 만듭니다. 데이터는 로컬 캐시에 저장되고 구성된 필드로 채워집니다. </p> <p>파싱된 데이터는 로컬 캐시에 기록됩니다. </p> <p>이 캐시는 Crawler에 필요한 간단한 HTML 문서를 만들기 위해 나중에 읽습니다. 예: </p> <p> <code class="syntax html"> &lt;html&gt;&lt;head&gt; 
      &lt;title&gt;{title}&lt;/title&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>각 문서 처리 </p> </td> 
   <td colname="col3"> <p>각 링크의 키 값은 캐시의 항목에 해당되므로 각 링크를 검색하면 캐시에서 해당 문서의 데이터를 가져옵니다. 그런 다음 HTML 이미지로 "조합"되어 처리되고 색인에 추가됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
속성 로더를 추가할 때 이 기능을 사용하여 데이터 소스 샘플 **[!UICONTROL Setup Maps]** 을 다운로드할 수도 있습니다. 그 데이터는 적합성을 검토한다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>탭을 먼저 시도한 다음 세로 막대( <span class="codeph"> | </span>) 및 쉼표( <span class="codeph"> , </span>)를 만듭니다. 설정 맵을 클릭하기 전에 이미 구분 기호 값 <span class="uicontrol"> 을 지정한 경우 해당 값 </span>이 대신 사용됩니다. </p> <p>최적의 구성표는 맵 필드가 적절한 태그 및 필드 값에 대한 추측으로 채워지는 결과를 가져옵니다. 또한 파싱된 데이터의 샘플링이 표시됩니다. 파일에 머리글 행 <span class="uicontrol"> 이 포함되어 </span> 있는 경우 첫 번째 행에서 머리글을 선택해야 합니다. 설정 함수는 이 정보를 사용하여 결과 맵 항목을 더 잘 식별합니다. </p> </td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>파일 구문 분석기가 전체 파일을 메모리로 읽으려고 하므로 대형 XML 데이터 세트에서 설정 맵 기능을 사용할 수 없습니다. 그 결과 메모리 부족 상태가 발생할 수 있습니다. 하지만 색인 작성 시 동일한 문서를 처리할 때 메모리로 읽히지 않습니다. 대신 대용량 문서는 &quot;이동 중&quot;에 처리되고 메모리로 완전히 읽지 않습니다.
...
1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Attribute Loader]**&#x200B;클릭합니다.
1. 페이지에서 [!DNL Stage Attribute Loader Definitions] 을 클릭합니다 **[!UICONTROL Add New Attribute Loader]**.
1. 페이지에서 [!DNL Attribute Loader Add] 원하는 구성 옵션을 설정합니다. 사용 가능한 옵션은 선택한 옵션에 따라 **[!UICONTROL Type]** 다릅니다.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>데이터 소스 선택하는 데이터 소스 유형은 속성 로더 추가 <span class="wintitle"> </span> 페이지에서 사용할 수 있는 결과 옵션에 영향을 줍니다. 다음 중에서 선택할 수 있습니다. </p> <p> 
      ...
      <td colname="col2"> <p>데이터가 있는 서버 호스트의 주소를 지정합니다. </p> <p>원하는 경우 다음 예와 같이 데이터 소스 문서의 전체 URI(Uniform Resource Identifier) 경로를 지정할 수 있습니다. </p> <p> <code otherprops="syntax html"> https://www.somewhere.com/some_path/some_file.tsv </code> </p> <p>또는  </p> <p> <code class="syntax html"> ftp://user:password@ftpserver.somewhere.com/some_path/some_file.csv </code> </p> <p>URI는 호스트 주소, 파일 경로, 프로토콜 및 선택적으로 사용자 이름 및 암호 필드에 적합한 항목으로 분류됩니다 </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>파일 경로 </p> </td> 
      <td colname="col2"> <p>간단한 플랫 텍스트 파일, 쉼표로 구분된 파일, 탭으로 구분 또는 기타 일관적으로 구분된 형식 파일의 경로를 지정합니다. </p> <p>경로는 호스트 주소의 루트에 상대적입니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>실패한 FTP, SFTP, HTTP 또는 HTTPS 연결에 대한 최대 재시도 횟수를 지정합니다. 이 값은 0에서 10 사이여야 합니다. </p> <p>값 0을 지정하면 다시 시도하지 않습니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>인코딩 </p> </td> 
      <td colname="col2"> <p>지정된 데이터 소스 파일에서 사용되는 문자 인코딩 시스템을 지정합니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <td colname="col2"> <p>속성 로더 데이터의 다운로드 사이의 최소 간격을 설정합니다. 다운로드 새로 고침 빈도 간격 내에 발생하는 색인 실행 다운로드는 무시됩니다. 이 값을 기본값인 1로 설정하면 속성 로더 데이터가 24시간 기간 내에 두 번 이상 다운로드되지 않습니다. 다운로드 새로 고침 빈도 간격 내에 발생하는 모든 검색 색인은 마지막으로 다운로드한 데이터 세트를 사용합니다. </p> </td> 
      </tr> 
      <tr> 
      ...
      <li id="li_5DFA514B7F9549B98D6CBC095A66033C"> <span class="uicontrol"> 메타데이터? </span> <p>필드가 <span class="uicontrol"> 현재 계정에 대해 정의된 메타데이터 필드를 선택할 수 있는 드롭다운 목록이 </span> 됩니다. </p> <p>원하는 경우 <span class="uicontrol"> 필드 </span> 값은 정의되지 않은 메타데이터 필드일 수 있습니다. 정의되지 않은 메타데이터 필드는 필터링 스크립트에서 사용하는 내용을 만드는 데 유용합니다 <span class="wintitle"> </span>. </p> <p>스크립트 필터링 <a href="../c-about-settings-menu/c-about-filtering-menu.md#concept_E56B73D625854AB2A899EF2D56CFCB47" type="concept" format="dita" scope="local"> 정보를 참조하십시오 </a>. </p> </li> 
      <li id="li_80DB205525094CE1AA6762BFC7892C95"> <span class="uicontrol"> 기본 키? </span> <p>하나의 필드만 기본 키로 식별됩니다. 이 필드는 인덱스의 해당 문서와 속성 로더 데이터를 일치시키기 위해 "외래 키"로 사용됩니다. </p> </li> 
      ...
      <tr> 
      <td colname="col1"> <p>파일 경로 </p> </td> 
      <td colname="col2"> <p>여러 개의 "행" 정보를 포함하는 기본 XML 문서의 경로를 지정합니다. </p> <p>경로는 호스트 주소의 루트에 상대적입니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>프로토콜 </p> </td> 
      <td colname="col2"> <p>파일에 액세스하는 데 사용되는 프로토콜을 지정합니다. 다음 중에서 선택할 수 있습니다. </p> <p> 
      ...
      <td colname="col2"> <p>지정한 데이터 소스 파일에서 개별 XML 행을 식별하는 데 사용할 수 있는 XML 요소를 식별합니다. </p> <p>예를 들어 Adobe XML 문서의 다음 피드 조각에서 Itemtag 값은 <span class="codeph"> 레코드입니다 </span>. </p> <p> <code class="syntax xml"> &lt;?xml&nbsp;version="1.0"&nbsp;encoding="utf-8"?&gt; 
      ...
      <td colname="col2"> <p>속성 로더 구성 데이터에 대한 조회 "키"로 사용되는 값이 있는 메타데이터 필드를 지정합니다. 값을 선택하지 않으면(<b>—None—</b>) 이 구성 데이터를 계산(규칙<b>&gt; 규칙</b> &gt; 규칙 <b></b> &gt; 규칙 <b>편집</b>등급)에서 사용할 수없습니다. 값을 선택하면 이 필드의 값이 이 구성 데이터를 사용하여 사이트 검색/머천다이징 문서를 상호 참조하는 데 사용됩니다. </p> </td> 
      </tr> 
      <tr> 
      <td colname="col1"> <p>부실 일 </p> </td> 
      <td colname="col2"> <p>속성 로더 데이터의 다운로드 사이의 최소 간격을 설정합니다. 다운로드 새로 고침 빈도 간격 내에 발생하는 색인 실행 다운로드는 무시됩니다. 이 값을 기본값인 1로 설정하면 속성 로더 데이터가 24시간 기간 내에 두 번 이상 다운로드되지 않습니다. 다운로드 새로 고침 빈도 간격 내에 발생하는 모든 검색 색인은 마지막으로 다운로드한 데이터 세트를 사용합니다. </p> </td> 
      ...
      <li id="li_0AF92270AE9F4BA8B2C7EE41FABC0F34"> <span class="uicontrol"> 태그 </span> <p>파싱된 XML 데이터의 XPath 표현을 지정합니다. 위의 예제 Adobe XML 문서를 사용하여 Itemtag 옵션 아래에서 다음 구문을 사용하여 매핑할 수 있습니다. </p> <p> <code class="syntax xml"> /record/@displayurl&nbsp;-&gt;&nbsp;page-url 
...
1. (선택 사항) 데이터 소스 **[!UICONTROL Setup Maps]** 의 샘플을 다운로드하려면 을(를) 클릭합니다. 그 데이터는 적합성을 검토한다.
1. 페이지 **[!UICONTROL Add]** 에 구성을 추가하려면 [!DNL Attribute Loader Definitions] 클릭합니다.
...
1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Attribute Loader]**&#x200B;클릭합니다.
1. 페이지 [!DNL Attribute Loader] 의 [!DNL Actions] 열 머리글 **[!UICONTROL Edit]** 에서 설정을 변경할 속성 로더 정의 이름을 클릭합니다.
1. 페이지에서 [!DNL Attribute Loader Edit] 원하는 옵션을 설정합니다.

   속성 로더 정의 [추가에서 옵션 테이블을 참조하십시오](../c-about-settings-menu/c-about-metadata-menu.md#task_A735E5EF763343A9B675E1A3B09AFDBC).
1. 클릭 **[!UICONTROL Save Changes]**.
...
속성 [로더 정의 편집을 참조하십시오](../c-about-settings-menu/c-about-metadata-menu.md#task_AA2D1B2BCAFA44A6A0C59A0318274E80).

**속성 로더 정의를 복사하려면**

1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Attribute Loader]**&#x200B;클릭합니다.
1. 페이지의 [!DNL Attribute Loader] 열 머리글 [!DNL Actions] 아래에서 설정을 복제할 속성 로더 정의 이름 **[!UICONTROL Copy]** 을 클릭합니다.
...
1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Attribute Loader]**&#x200B;클릭합니다.
1. 페이지의 [!DNL Attribute Loader] 열 머리글 [!DNL Actions] 아래에서 **[!UICONTROL Rename]** 변경할 속성 로더 정의 이름을 클릭합니다.
1. 페이지의 [!DNL Attribute Loader Rename] 필드에 새 정의 이름을 [!DNL Name] 입력합니다.
...
구성된 속성 로더 데이터를 사이트 검색/머천다이징으로 다운로드할 수 있습니다.
...
1. 페이지에서 **[!UICONTROL Attribute Loader Data Load]** 다음 중 하나를 수행합니다.
   ...
   * 로드 작업 **[!UICONTROL Start Load]** 을 시작하려면 을 클릭합니다.

      데이터 로드 작업 중에&#x200B;**진행률** 행은 진행 상태에 대한 정보를 제공합니다.

   * 로드 작업 **[!UICONTROL Stop Load]** 을 중지하려면 을(를) 클릭합니다.
...
테이블의 행 열에는 속성 로더 값이 로드되었던 원래 순서를 나타내는 각 데이터 행의 숫자가 표시됩니다.

나머지 열에는 각 항목과 연관된 값이 표시됩니다.

테이블이 비어 있으면 속성 로더 데이터를 아직 로드하지 않았음을 의미합니다. 페이지를 [!DNL Attribute Loader Data Preview] 닫은 다음 속성 로더 데이터를 로드할 수 있습니다.

속성 [로더 데이터 로드를 참조하십시오](../c-about-settings-menu/c-about-metadata-menu.md#task_2F3C55189B0A4049AB2113F2291CC181).

**속성 로더 데이터를 미리 보려면**

1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Attribute Loader]**&#x200B;클릭합니다.
1. 페이지의 [!DNL Attribute Loader Definitions] 열 [!DNL Actions] 아래에서 **[!UICONTROL Preview]** 다운로드된 데이터를 보려는 구성을 클릭합니다.
1. 페이지에서 페이지 [!DNL Attribute Loader Data Preview] 위쪽과 아래쪽에 있는 탐색 및 보기 옵션을 사용하여 데이터를 봅니다.

   테이블의 열 머리글을 클릭하여 데이터를 오름차순 또는 내림차순으로 정렬합니다.
1. 다음 중 하나를 수행합니다.
...
속성 로더 정의를 페이지에 추가한 후에는 [!DNL Attribute Loader Definitions] 해당 유형 설정을 변경할 수 없습니다. 대신 정의를 삭제한 다음 새로 추가해야 합니다.
...
1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Attribute Loader]**&#x200B;클릭합니다.
1. 페이지 [!DNL Attribute Loader] 의 [!DNL Actions] 열 머리글 **[!UICONTROL Edit]** 에서 설정을 검토하거나 편집할 속성 로더 정의 이름을 클릭합니다.

## 최신 속성 로더 데이터 로드에서 로그 보기 {#task_9C7D6E34BB6C4A40B7CA3EE36ACB0837}

를 사용하여 최신 다운로드 프로세스 [!DNL View Log] 의 속성 로더 데이터 로그 파일을 검사할 수 있습니다. 로그 보기를 사용하여 실행 중인 다운로드를 모니터링할 수도 있습니다.
...
1. 페이지에서 페이지 [!DNL Attribute Loader Data Log] 위쪽과 아래쪽에 있는 탐색 및 보기 옵션을 사용하여 로그 정보를 봅니다.
...
1. 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > 를 **[!UICONTROL Attribute Loader]**&#x200B;클릭합니다.
1. 페이지 [!DNL Attribute Loader Definitions] 의 [!DNL Actions] 열 머리글 **[!UICONTROL Delete]** 에서 제거할 속성 로더 정의 이름을 클릭합니다.
