...
* [SWF를 색인화하려면 어떻게 해야 합니까?](#section_0A6A52CC70D4495BBE14D91906318F95)
...
* [SWF 파일이 ...에서 인덱스되지 않도록 하려면 어떻게 해야 합니까?](#section_DF2606A50E9A44859CFA0D44D7C5F2E4)
...
SWF 파일을 크롤링 및 색인화하려면 컨텐츠 유형 **[!UICONTROL Adobe Flash Movies]** ( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)을 선택합니다.
...
SWF 인덱싱을 비활성화하려면 콘텐트 유형을 선택 **[!UICONTROL Adobe Flash Movies]** 취소합니다( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**).

SWF 파일의 인덱싱을 비활성화하는 [!DNL URL Masks] 데 사용할 수도 있습니다.

색인 [부분에 URL 마스크 추가...](../c-about-settings-menu/c-about-crawling-menu.md#task_E1AFC17C746048B8843013D979E082C1).
...
사이트 검색/머천다이징은 Adobe Flash로 제작한 SWF 파일에서 UTF-8을 가져옵니다. UTF-8에는 언어가 표시되지 않습니다. 내용 유형을 선택한 **[!UICONTROL Adobe Flash Movies]** 경우( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**) 메타데이터 주입을 사용하여 SWF 파일에서 사용되는 언어를 지정해야 합니다.

필드 [삽입 정의](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)추가를 참조하십시오.

이전 SWF 파일에서도 문자 집합을 지정하지 않습니다. SWF 내용 유형 **[!UICONTROL Adobe Flash Movies]** ( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)을 선택한 경우 메타데이터 주입을 사용하여 SWF 파일에 사용되는 문자 세트를 지정해야 합니다.
...
* [주별로 이메일 주소를 변경하는 방법은 무엇입니까?](#section_AE27F63DD13F425B940C8E7D9ED5C614)
* [사이트 검색/머천다이징에 대한 고객 정보는 얼마나 안전합니까?](#section_5484CB954167412BB7F0480CB0C504B8)
...
* [고객이 무엇을 찾고 있는지 알 수 있습니까?](#section_73709E1B0E82478DA7B4D15B6C845F33)
* [어떤 컨텐츠 유형(PDF, 텍스트, Flash, MP3 및 Microsoft Office)이 인덱싱되어 검색되는지 어떻게 제어할 수 있습니까?](#section_0AB8CB4B6BFA4286AA082055FEBFBE1C)
* [ASP, JSP, PHP, CFM 또는 Perl 기반 컨텐츠를 통해 동적으로 생성된 웹 페이지가 지원됩니까?](#section_E279F004F1C542A2B9773B832E7B013F)
* [동의어를 사용하여 검색 결과를 향상시키는 방법...](#section_E6E36E12514F4D7BAB01F8D1AB61D57B)
...
* [사이트를 별도의 섹션으로 분할할 수 있으므로...](#section_52153A9DE9F9493B967A70583848B2A4)
* [웹 사이트의 일부를 제외하는 방법은 무엇입니까?](#section_D452EDE153654EF398F4A87780C6D43B)
...
* [나는 내 웹사이트에서 암호를 사용한다. 사이트 검색/머천다이징을 계속 사용할 수 있습니까?](#section_4618EB5B66704640B5502D1B5CB4B32E)
* [https 또는...의 크롤링 및 색인화를 지원합니까?](#section_D5BB8B8FBEA4405583E86B4AEC37151B)
* [사이트 검색/머천다이징은 내 웹 사이트의 robots.txt 파일을 승인합니까?](#section_73BBF6FE93C64C109F45CBC2FA394DB2)
* [웹 사이트의 특정 부분은 자주 업데이트해야 합니다.](#section_6D2FB1DE1B8A49729F9CCAE2A2770AB3)
* [스크립트 또는 프로그램을 사용하여 증분 작업을 시작할 수 있습니까?](#section_0B6BB039557A42AA876D35D748E17DD0)
...
전체 [색인 정보를 참조하십시오](../c-about-index-menu/c-about-full-index.md#concept_C69BD21863FD4856B49326F35DB570D3).
...
주별 보고서는 각 활성 계정의 소유자에게 전송됩니다. > **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** >를 클릭하여 이메일 주소를 변경할 수 **[!UICONTROL Personal Information]**&#x200B;있습니다. 활성 검색 계정이 두 개 이상 있으면 모든 뉴스레터가 새 주소로 전송됩니다.
...
Adobe는 고객 및 방문자의 개인 정보를 보호하기 위해 최선의 노력을 다하고 있습니다. Adobe 개인정보 보호 [센터를 참조하십시오](https://www.adobe.com/privacy.html).
...
## 사이트에서 어떤 고객이 검색하는지 확인할 수 있습니까? {#section_73709E1B0E82478DA7B4D15B6C845F33}
...
검색 로봇은 에 지정된 웹 사이트 주소의 첫 번째 페이지에서 시작하여 웹 사이트를 탐색하고 [!DNL Account Settings]페이지마다 링크를 따릅니다.
...
예를 들어 사이트에서 판매할 제품의 가격 목록이 포함된 페이지가 있다고 가정합니다. 그러나 사이트 검색/머천다이징에서 제공하는 검색 보고서를 검토한 후 고객이 검색에서 &quot;비용&quot;, &quot;비용&quot;, &quot;비용&quot; 또는 &quot;비용&quot;이라는 단어를 찾고 있는 것을 확인할 수 있습니다. 이러한 단어는 검색 결과에 가격 목록 페이지를 표시하지 않습니다. 의 [!DNL Add Synonyms] 기능을 [!DNL Dictionaries]사용하면 이러한 단어가 모두 동의어임을 지정할 수 있으며 고객은 사용하는 검색어에 상관없이 가격 목록을 찾을 수 있습니다.
...
## Adobe 고객 로그인 시 사이트를 두 개 이상 보유할 수 있습니까? {#section_AFA8825182094660A71EEC84B8329D6D}

예. 단일 Adobe 고객 로그인을 사용하면 다양한 웹 사이트에 대해 다른 검색 엔진을 관리할 수 있습니다. &quot;계정&quot;에서 계정을 선택하고 관리합니다.

사용할 [다른 계정 선택을](../c-about-accounts-menu.md#task_03C0FE918E2D44529CDC3B8DB75D1B26)참조하십시오.

## 두 개 이상의 도메인을 검색할 수 있습니까? {#section_BFBB0E9861D942F095B56CF0A8F16596}

예. 를 사용하여 두 개 이상의 도메인에 대한 액세스를 구성할 수 [!DNL URL Entrypoints]있습니다. 소유한 추가 도메인에 대한 URL 진입점을 제공합니다. 소유하지 않은 도메인을 인덱싱할 수 있는 권한이 있어야 합니다.

URL [시작 지점 정보를 참조하십시오](../c-about-settings-menu/c-about-crawling-menu.md#concept_5D857E3B5C124E85BC0B5AE77A509573).

## 고객이 이러한 영역을 개별적으로 또는 전체 사이트를 검색할 수 있도록 사이트를 별도의 섹션으로 나눌 수 있습니까? {#section_52153A9DE9F9493B967A70583848B2A4}
...
## 웹 사이트의 일부 부분은 검색되지 않도록 하려면 어떻게 해야 합니까? {#section_D452EDE153654EF398F4A87780C6D43B}
...
URL [마스크 스크립트](../c-about-settings-menu/c-about-filtering-menu.md#concept_384F32EA18F84853A7BA99A04009330B)정보를 참조하십시오.

개별 웹 페이지의 일부가 검색되지 않도록 하려면 페이지의 일부를 인덱스에서 제외할 수 있습니다. 텍스트를 `<noindex>` 및 `</noindex>` 태그로 둘러싸십시오. 이 방법은 검색에서 탐색 텍스트를 제외하려는 경우에 유용합니다.
...
<table> 
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>일본어(Shift_JIS 파섹) </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>남부 유럽(ISO-8859-3) </p> </td> 
  </tr> 
  <tr> 
...
라이브 [웹 사이트에](../c-about-index-menu/c-about-incremental-index.md#task_2A46BA189ECC4317A9D5C6E99A336F33)대한 증분 인덱스 일정 설정을 참조하십시오.
...
웹 [사이트의 필수 영역에 액세스하기 위한 암호 추가를 참조하십시오.](../c-about-settings-menu/c-about-crawling-menu.md#task_DED19D476FF04B48BB6456D5ECB8628A).
...
## 고객이 가장 정확한 검색 결과를 얻을 수 있도록 웹 사이트의 특정 부분을 자주 업데이트해야 합니다. 증분 인덱싱을 통해 이 문제가 해결됩니까? {#section_6D2FB1DE1B8A49729F9CCAE2A2770AB3}
...
## 스크립트나 프로그램을 사용하여 사이트의 증분 인덱스를 시작할 수 있습니까? {#section_0B6BB039557A42AA876D35D748E17DD0}
...
의 다양한 기능 구현에 대해 설명하는 FAQ 페이지입니다 [!DNL Search&Promote].

다음은 웹 사이트의 기능 구현과 관련된 일반적인 [!DNL Search&Promote] 질문입니다.

* [비즈니스 규칙이 실행되지 않는 이유는 무엇입니까?](#section_7FEB60383D8A4B11A60DFF9067274699)
* [색인 예약, 색인 시작 오류, 스테이지된 색인 시작 문제가 발생하는 이유는 무엇입니까?](#section_E05758193DF5436784B0145839989F75)
* [색인 크기 제한이 허용된 경계를 초과합니다. 이 문제는 왜 발생하며 어떻게 수정합니까?](#section_12E7DA979C4C4B1D8A3A6415FC3DDA70)

## 비즈니스 규칙이 실행되지 않는 이유는 무엇입니까? {#section_7FEB60383D8A4B11A60DFF9067274699}

배너가 표시될 때 비즈니스 규칙을 구성하거나 결과가 표시되는 내용과 순서를 결정하는 데 도움이 됩니다. 패싯에서 항목의 위치와 지정된 검색에 사용되는 템플릿을 구성할 수도 있습니다.
비즈니스 규칙의 순서를 변경하여 프레젠테이션 템플릿에서 실행하는 순서를 변경할 수 있습니다. 비즈니스 규칙은 정의된 순서대로 실행됩니다.즉, 규칙의 주문 번호가 높을수록 나중에 프로세스에서 실행되어 이전 규칙보다 우선합니다. [비즈니스 규칙] 페이지의 테이블의 [순서] 열에 새 번호를 입력하여 규칙 순서를 변경합니다.
...
인덱스를 예약하려면 [라이브 웹 사이트에](../c-about-index-menu/c-about-full-index.md#task_6760F3256D004A228B38968DF15421F0) 대한 전체 인덱스 일정 설정 및 실시간 웹 사이트에 [대한](../c-about-index-menu/c-about-incremental-index.md#task_2A46BA189ECC4317A9D5C6E99A336F33)증분 인덱스 예약 설정을 참조하십시오.

스테이지된 색인을 시작하는 방법은 [라이브 또는 스테이지된 웹 사이트의 전체 인덱스 실행...을 참조하십시오.](../c-about-index-menu/c-about-full-index.md#task_F7FE04D8A1654A7787FCCA31B45EB42D) 또는 [라이브 또는 스테이지된 웹 사이트의 증분 색인 실행 중...](../c-about-index-menu/c-about-incremental-index.md#task_9BFB6157F3884B2FAECB7E0E9CA318CB).

## 색인 크기 제한이 허용된 경계를 초과합니다. 이 문제는 왜 발생하며 어떻게 수정합니까? {#section_12E7DA979C4C4B1D8A3A6415FC3DDA70}

웹 사이트는 시간이 지남에 따라 확장되는 경향이 있으며 Search&amp;Promote는 추가된 더 많은 문서와 웹 페이지를 &quot;검색&quot;합니다. 결국 귀하의 계정이 인덱싱 크기 제한을 초과할 수 있습니다. 이러한 경우 사용을 고려할 수 **[!UICONTROL URL Mask]**&#x200B;있습니다. 이 기능은 색인을 원하지 않거나 색인이 필요하지 않은 색인 크롤링(crawing)에서 문서 및 웹 페이지를 숨겨 색인 크기를 줄입니다. 색인 크기 제한이 계정에서 더 크게 설정되도록 하려면 기술 지원에 문의하는 방법도 있습니다.
...
중국어(간체 및 번체), 일본어 및 한국어와 같은 멀티바이트 아시아 언어를 포함하여 19개 이상의 언어에 대한 인덱싱 및 검색 지원에 대해 설명하는 FAQ 페이지입니다.

언어 및 문자 집합에 대한 일반적인 질문은 다음과 같습니다.

* [검색 쿼리의 문자 집합 인코딩을 제어하는 것...](#section_DF2E8570AFC2480FA199FD26C941A22F)
* [인코딩과 일치하는 페이지만 검색됩니다.](#section_9E544F3DB7DE41618DC1BC8224B32C5A)
...
* [뭔가 특별한 일을 해야...](#section_A8BA6DDD3A6048319D3530BCFD6DA1A5)
* [Netscape 4.7 및 이전 버전에서 중국어, 일본어 또는 한국어 글꼴은 어떻게 검색 결과에 표시됩니까?](#section_DF42567063304F918D406AC76529DFB7)

## 검색 쿼리의 문자 집합 인코딩을 제어하는 것은 무엇입니까? {#section_DF2E8570AFC2480FA199FD26C941A22F}

검색 계정의 &quot;웹 양식&quot; 섹션에는 검색 기능을 웹 사이트에 추가하는 데 사용하는 샘플 검색 양식이 포함되어 있습니다. 이 검색 양식 코드를 보면 다음과 유사한 라인을 찾을 수 있습니다.

`<input type=hidden name="sp_f" value="iso-8859-1">`

이 코드 행은 들어오는 쿼리가 서유럽 언어에 대한 일반적인 인코딩인 iso-8859-1로 인코딩되었음을 검색 엔진에 알립니다. 제품 메뉴로 이동한 다음 **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]**&#x200B;을 클릭하여 이 설정을 변경할 수 있습니다. 페이지의 [!DNL Personal Information] **[!UICONTROL Character Encoding]** 드롭다운 목록에서 새 인코딩을 선택합니다.

개인 [사용자 정보](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6)구성을 참조하십시오.

검색 양식의 `sp_f` 줄을 편집하여 웹 페이지의 인코딩 값을 수동으로 변경할 수도 있습니다. 검색 양식의 `sp_f` 값은 표시되는 페이지의 문자 집합 인코딩과 일치해야 합니다.

## 검색 쿼리의 인코딩과 일치하는 인코딩의 페이지만 검색됩니까? {#section_9E544F3DB7DE41618DC1BC8224B32C5A}
...
사이트 검색/머천다이징은 Adobe PDF 파일에서 언어를 표시하지 않고 UTF-8을 가져옵니다. 선택 **[!UICONTROL PDF Documents]** ( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)한 경우 메타데이터 주입을 사용하여 PDF 파일에 사용되는 언어를 지정해야 합니다.

필드 [삽입 정의](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)추가를 참조하십시오.

## 웹 사이트에서 중국어, 일본어 또는 한국어 SWF 파일을 검색할 수 없는 이유는 무엇입니까? {#section_9C0849528AFF4C10AA97A2C912992638}

사이트 검색/머천다이징은 Adobe Flash로 만든 Adobe Flash 동영상 파일에서 언어 표시 없이 UTF-8을 가져옵니다. 내용 유형을 선택한 **[!UICONTROL Adobe Flash Movies]** 경우( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**) 메타데이터 주입을 사용하여 SWF 파일에 사용되는 언어를 지정해야 합니다.

Flash 버전 4 또는 이전 버전의 SWF 파일의 경우 파일에 있는 문자 집합이 지정되지 않습니다. 내용 유형을 선택한 **[!UICONTROL Adobe Flash Movies]** 경우( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**) 메타데이터 주입을 사용하여 SWF 파일에 사용되는 문자 집합을 지정해야 합니다.

필드 [삽입 정의](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)추가를 참조하십시오.

## 웹 사이트에서 중국어, 일본어 또는 한국어 Microsoft Office 파일을 검색할 수 없는 이유는 무엇입니까? {#section_6764BA6863AF492EBA9BE5CCC12CDD1F}

사이트 검색/머천다이징은 Microsoft Office 파일(Microsoft Word, Microsoft Excel 및 Microsoft PowerPoint)에서 언어를 표시하지 않고 UTF-8을 가져옵니다. 콘텐트 유형을 선택한 **[!UICONTROL Microsoft Office Files]** 경우( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**) 메타데이터 주입을 사용하여 Microsoft Office 파일에서 사용되는 언어를 지정해야 합니다.

필드 [삽입 정의](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)추가를 참조하십시오.

## 웹 사이트에서 중국어, 일본어 또는 한국어 MP3 파일을 검색할 수 없는 이유는 무엇입니까? {#section_DB6D60CF46F94125BF4E54AF3036DBFC}

컨텐츠 유형 **[!UICONTROL Text in MP3 Music Files]** ( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)을 선택하는 경우 메타데이터 주입을 사용하여 MP3 파일을 인코딩하는 데 사용되는 문자 세트를 지정해야 합니다.

필드 [삽입 정의](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)추가를 참조하십시오.

## 웹 사이트에서 .txt 파일을 올바로 인덱싱하려면 특별한 작업이 필요합니까? {#section_A8BA6DDD3A6048319D3530BCFD6DA1A5}

컨텐츠 유형을 선택한 **[!UICONTROL Text Documents]** 경우( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**) 메타데이터 주입을 사용하여 .txt 파일을 인코딩하는 데 사용되는 문자 세트를 지정해야 합니다.
...
낮은 인덱싱 페이지 수와 관련된 일반적인 문제를 설명하는 FAQ 페이지입니다.

다음은 낮은 인덱싱 페이지 카운트와 관련된 일반적인 질문입니다.

* [색인 로그를 검토했습니까?](#section_D6626536DC3D40DDA4A1224F1CB276BF)
* [URL에 타이핑 오류가 있습니까?](#section_BD2CEABC5D0F4A0DA38F3AD72ABBA676)
...
* [웹 페이지의 HTML 태그가](#section_F31A2F5D2C284AC084158A5BD763DC5D)
...
제품 메뉴에서 > **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**&#x200B;을 클릭합니다. 페이지에서 [!DNL Staged URL Entrypoints] 다음을 확인합니다.
...
이러한 경우 웹 페이지의 올바른 시퀀스에 `<html>`태그, `<head>`및 `<body>` 태그를 배치합니다.

## 웹 페이지에서 HTML 주석 태그를 잘못 구성했습니까? {#section_D1C39D79341845CB9C38579AABDF3A24}
...
제품 메뉴에서 > **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**&#x200B;을 클릭합니다. 사이트의 &quot;기본 웹 사이트 시작 지점&quot; URL을 추가합니다. 그런 다음 사이트 페이지를 포함하는 다른 모든 도메인에 URL 진입점을 추가합니다. 예를 들어 기본 URL 진입점을 다음과 같이 설정합니다.
...
제품 메뉴에서 > **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**&#x200B;을 클릭합니다. 사이트의 가상 도메인 이름에 &quot;기본 웹 사이트 URL 시작 지점&quot;을 추가합니다. 그런 다음 웹 사이트가 실제로 존재하는 도메인에 추가 진입점을 추가합니다.
...
제품 메뉴에서 > 크롤링 **[!UICONTROL Settings]** > **[!UICONTROL URL Entrypoints]**&#x200B;을 클릭합니다. 메타 새로 고침 태그의 URL에 다른 진입점을 추가합니다.
...
* [Microsoft Office 파일에서 인덱싱되지 않는 항목...](#section_BD53BDABFDD94D7EB0E1F55EC18017BB)
* [Microsoft Office 파일은 HTML 페이지와 어떻게 다르게 인덱싱됩니까?](#section_C104B44684F340549A6B9EB8F39EDDBB)
...
## Microsoft Office 파일에서 색인화되지 않은 것은 무엇입니까? {#section_BD53BDABFDD94D7EB0E1F55EC18017BB}
...
검색 로봇이 Microsoft Office 파일을 크롤링 및 색인화하지 않도록 하려면 내용 유형 **[!UICONTROL Microsoft Office Files]** ( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)을 선택 해제합니다.

를 사용하여 Microsoft Office [!DNL URL Masks] 파일의 인덱싱을 비활성화할 수도 있습니다.
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_012A45C3EC04460EA09C0ECFB49A8FA9"> 
     <li id="li_0C239F0A536D465F85A98EBF7B6ADF27">regexp ^를 제외합니다.*\.doc$ </li> 
     <li id="li_9F91DA35A2A646ACAFF2BA37F9136E2A">regexp ^를 제외합니다.*\.xls$ </li> 
     <li id="li_9D768D9EA2DB44FBB00A1979E21672E2">regexp ^를 제외합니다.*\.ppt$ </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
다음은 MP3 파일에 대한 일반적인 질문입니다.

* [MP3 파일은 언제 크롤링 및 인덱싱됩니까?](#section_538EA1682C9C47E3A62640BB25D84C36)
* [기어가고 색인화하려면 어떻게 해야 합니까?](#section_3CD794446E3545379C14E9F222118665)
...
* [MP3 파일은 페이지로 계산됩니까?](#section_9910BEB6617D4D2090558CDF6C65D16B)
* [개별 MP3 파일의 인덱싱을 방지하려면 어떻게 해야 합니까?](#section_C989DC1D3D3841B38F683A462195DC05)
* [MP3 파일이 인덱싱되지 않도록 하려면 어떻게 해야 합니까?](#section_305D2B28D1124776B6DC0C62A17827C6)
* [내 사이트에서 중국어, 일본어 또는 한국어 MP3 파일을 검색할 수 없는 이유는 무엇입니까?](#section_06A48DA3F9E742CC93CC8B5CCD7382FA)
...
## 사이트에서 MP3 파일을 크롤링 및 색인화하려면 어떻게 해야 합니까? {#section_3CD794446E3545379C14E9F222118665}

계정에 대한 MP3 크롤링 및 인덱싱을 활성화하려면 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**&#x200B;을 클릭합니다. 페이지에서 [!DNL Staged Content Types] 을 선택합니다 **[!UICONTROL Text in MP3 Music Files]**.
...
계정에 대한 MP3 인덱싱을 제어하는 가장 쉬운 방법은 **[!UICONTROL Text in MP3 Music Files]** [!DNL Staged Content Types] 페이지에서 선택을 취소하는 것입니다.

크롤링 [및 색인을](../c-about-settings-menu/c-about-crawling-menu.md#task_CCAC5C67C8BF4AB7B79D34A1495D5EE8)위한 컨텐츠 유형 선택을 참조하십시오.

또한 URL 마스크 기능을 사용하여 파일 확장명에 의한 MP3 인덱싱을 비활성화할 수 있습니다. 이렇게 하려면 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Masks]**&#x200B;을 클릭합니다. 다음 마스크 중 하나를 입력합니다.

<table> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>계정이 </p> </th> 
   <th colname="col2" class="entry"> <p>다음 URL 마스크 입력 </p> </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>정규 표현식을 사용합니다. </p> </td> 
   <td colname="col2"> <p> <span class="codeph"> regexp ^를 제외합니다.*\.mp3$ </span> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
중국어, 일본어 또는 한국어 MP3 파일을 검색하려면 제품 메뉴에서 **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]** > **[!UICONTROL Text in MP3 Music Files]**&#x200B;를 클릭합니다. 그런 다음 **[!UICONTROL Settings]** > **[!UICONTROL Metadata]** > **[!UICONTROL Injections]**&#x200B;을 클릭하고 MP3 파일을 인코딩하는 데 사용되는 문자 집합을 지정합니다.
...
다음은 PDF 파일에 대한 일반적인 질문입니다.

* [PDF 파일에서 색인이 되는 항목](#section_62BFCD7158B44F2BB3B1864224B50174)
* [PDF 파일에서 색인이 되지 않는 것은 무엇입니까?](#section_A14B353AE503408896BACBBF3F748FA0)
...
* [검색 결과 링크가](#section_A06E7F7017E6441E98209D288EE57BF6)
* [PDF 파일이 색인화되지 않도록 하려면 어떻게 해야 합니까?](#section_96671419A822486AAC654D8DAD819940)
...
## 웹 사이트에서 PDF 파일이 색인화되지 않도록 하려면 어떻게 해야 합니까? {#section_96671419A822486AAC654D8DAD819940}

검색 로봇이 PDF 파일을 크롤링 및 색인화하지 않도록 하려면 컨텐츠 유형 **[!UICONTROL PDF Documents]** ( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**)을 선택 취소합니다.

PDF 색인을 비활성화할 [!DNL URL Masks] 수도 있습니다.
...
사이트 검색/머천다이징은 PDF 파일에서 언어를 표시하지 않고 UTF-8을 가져옵니다. 콘텐트 유형을 선택한 **[!UICONTROL PDF Documents]** 경우( **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**) 메타데이터 주입을 사용하여 PDF 파일에 사용되는 언어를 지정해야 합니다.

필드 [삽입 정의](../c-about-settings-menu/c-about-metadata-menu.md#task_E86566FA1FF74CF68115C0ADA05172AE)추가를 참조하십시오.

## 페이지가 너무 많습니다. {#reference_48A748BC1ED14844ACAC2735C8388E8A}
...
* [다양한 색인 로그를 검토하셨나요?](#section_C929BF9FDA6B4C9A9078C45AFE80EFE8)
* [CGI 프로그램이 웹 사이트에서 인덱싱되고 있습니까?](#section_86ED8A641B3841EC80153B4F107548FD)
* [서버에서 디렉토리 검색을 활성화합니까?](#section_073C88EEE74F4CA0AD2C7145D4810B22)
...
라이브 [또는 스테이지 웹 사이트의](../c-about-index-menu/c-about-re-rank-index.md#task_3C76107DFAC1495FACD3ABB0A688208D)등급 다시 지정 색인 로그 보기를 참조하십시오.
...
웹 서버에 디렉토리 검색이 활성화되어 있고 해당 디렉토리에 index.html 파일이 없는 경우 해당 디렉토리를 방문하면 해당 디렉토리에 있는 파일의 목록이 표시됩니다. 일반적으로 페이지 맨 위에는 클릭, **[!UICONTROL Name]****[!UICONTROL Last modified]**&#x200B;등을 통해 목록을 다른 방식으로 정렬할 수 있는 링크가 **[!UICONTROL Size]**&#x200B;있습니다. 일반적으로 이러한 URL은 사이트 검색/머천다이징 색인 로그에 URL로 표시되며 `?M=A` 끝에는 과 같은 문자가 있습니다. 사이트 검색/머천다이징 인덱서는 이러한 링크를 링크로 따르며, 이로 인해 여러 &quot;위조&quot; URL을 인덱싱할 수 있습니다.
...
이 작업을 수행하려면 **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Masks]**&#x200B;을 클릭합니다. 문자를 포함하는 URL에 마스크를 추가하여 마스크를 `?`적용합니다. 다음 정규 표현식 마스크를 입력하여 이 작업을 수행할 수 있습니다.
...
일반적으로 포럼이나 뉴스 그룹에는 자체 검색 엔진이 포함되어 있습니다. 이러한 경우 를 [!DNL URL Masks] 사용하여 사이트 검색/머천다이징에서 포럼에 마스크를 적용할 수 있습니다.

제품 메뉴에서 > **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Masks]**&#x200B;을 클릭합니다. 페이지에서 URL을 제외 URL 마스크로 입력하여 포럼에 마스크를 적용합니다. [!DNL Staged URL Masks]
...
웹 사이트에 PDF 파일 또는 [!DNL Microsoft Office] 파일이 있는 경우 몇 개의 파일의 인덱스 크기만 많은 페이지를 카운트한다는 것을 알 수 있습니다. PDF 또는 Microsoft Office 파일의 각 페이지가 별도의 페이지로 계산되기 때문에 현재 문서보다 색인이 많은 페이지가 있습니다.

제품 메뉴에서 > **[!UICONTROL Index]** > **[!UICONTROL Full Index]** > **[!UICONTROL Live Index]**&#x200B;을 클릭합니다. 페이지에서 [!DNL Full Index] 선택한 **[!UICONTROL Count All Pages]**&#x200B;다음 을 클릭하여 총 페이지 수를 **[!UICONTROL Full Index Now]** 봅니다. PDF 파일 또는 Microsoft Office 파일의 색인을 원하지 않는 경우 **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**&#x200B;에서 이 콘텐트 유형을 비활성화할 수 있습니다.
