...
스테이지된 웹 사이트](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0)의 증분 색인 구성을 참조하십시오.[
...
* 한 문자 정규 표현식은 한 문자 정규 표현식과 일치하는 모든 항목을 일치하는 일반 표현식입니다.
...
* 한 문자 정규 표현식 뒤에 `+`(더하기 기호)가 오는 일반 표현식은 한 문자 이상의 정규 표현식과 일치하는 정규 표현식으로, 보조 코드 집합 문자일 수 있습니다. 선택할 수 있는 경우 일치를 허용하는 가장 긴 왼쪽 문자열이 선택됩니다.
