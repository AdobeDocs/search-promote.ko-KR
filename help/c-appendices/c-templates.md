...
선언은 최상위 프레젠테이션 템플릿의 맨 위에서 설정할 수 있는 특수 선언 태그입니다. 포함된 템플릿의 선언을 포함하여 이후의 모든 선언이 무시됩니다.
...
<td colname="col2"> <p>패싯 값 루프 내의 현재 패싯 값이 길이 임계값과 같은지 결정합니다. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col1"> <p> 
    ...
    &amp;lt;/guided-if-faction[-not]-visible&amp;gt;&lt;/code> &lt;/p> &lt;/td>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>레이블 태그는 탐색 표시 항목을 생성하기 위해 선택한 패싯을 자세히 표시한 탐색 표시 값에 대한 레이블을 출력합니다. 안내 탐색 표시 <span class="codeph"> </span> 블록의 컨텍스트에서만 사용됩니다. </p> <p> <code class="syntax html"> &lt;guided-breadcrumb&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;guided-breadcrumb-link&gt; 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colname="col01"> <p>1 </p> </td> 
   <td colname="col1"> <p> 
     <!--Matches search-eng version, 2/1/2013--> <span class="codeph"> &lt;guided-progress&gt;&lt;/guided-congends&gt; </span> </p> </td> 
   <td colname="col2"> <p>제안 사항을 루프하기 위한 루프 태그입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> 
     <!--Matches search-eng version, 2/1/2013--> <span class="codeph"> &lt;guided-provision-link [attr="value"]+&gt;&lt;/guided-provision-link&gt; </span> </p> </td> 
   <td colname="col2"> <p>지정된 제안에 대한 링크를 만듭니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> 
     <!--Newly added from search-eng version, 2/1/2013--> <span class="codeph"> &lt;guided-provision-value /&gt; </span> </p> </td> 
   <td colname="col2"> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
  ...
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-provision-path/&gt; </span> </p> </td> 
   <td colname="col2"> <p>제안 경로 문자열을 반환합니다. 앵커 태그를 직접 만드는 데 사용할 수 있습니다. 일반적으로 <span class="codeph"> 안내 추천 링크 </span> 가 대신 사용됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-provisions/&gt; </span> </p> </td> 
   <td colname="col2"> <p>제안이요 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-provision-result-count/&gt; </span> </p> </td> 
   <td colname="col2"> <p>제안 결과 카운트입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>8 </p> </td> 
   ...
   <td colname="col2"> <p>이 기능이 켜진 경우를 위해 0의 결과로 자동 검색이 수행되었는지 여부를 테스트할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-provisions-original-query/&gt; </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이 기능은 낮은 결과 카운트로 인해 제안이 있는 경우, 이 기능을 사용하는 경우 적용됩니다. </p> <p>다음은 이 태그를 사용하는 예입니다. </p> <p> <code class="syntax html"> &lt;guided-if-suggestion-low-results&gt; 
...
다음 태그를 사용하여 검색 양식에 자동 완성 기능을 추가할 수 있습니다. 자동 완성 기능을 올바르게 만들려면 헤드 컨텐츠 및 양식 컨텐츠 태그가 필요합니다. 프레젠테이션 템플릿에 자동 완성 Javascript 및 CSS를 하드 코딩하는 대신 태그를 사용하는 것이 좋습니다. 이유는 템플릿을 수동으로 업데이트할 필요 없이 자동 완성 설정을 변경할 때마다 태그로 인해 템플릿이 새로운 패싯 캐시 ID를 가져올 수 있기 때문입니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>자동 완성 기능이 활성화되어 있는지 여부를 검색합니다. 태그를 사용하여 자동 완성에 필요한 헤드 및 양식 컨텐츠를 선택적으로 가져올 수 있습니다. 따라서 프레젠테이션 템플릿을 변경할 필요 없이 기능을 켜거나 끌 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>양식 내에서 자동 완성 태그를 하드 코딩하는 대신 프레젠테이션 템플릿의 <span class="codeph"> &lt;form&gt; </span> 과 <span class="codeph"> &lt;/form&gt; </span> 태그 사이 검색 양식에서 사용됩니다. 태그가 자동 완성 작업에 필요한 적절한 HTML로 대체됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-ac-javascript/&gt; </span> </p> </td> 
   <td colname="col2"> <p>자동 완성 JavaScript에 대한 링크를 생성합니다. 최상의 성능을 얻으려면 이 태그를 닫는 "body" 태그 앞에 페이지 하단에 삽입하는 것이 좋습니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>사용자가 gsname 매개 변수가 지정하는 스토어 <span class="codeph"> 에 있는지 </span> 검색합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>영역 태그의 모든 컨텐츠를 둘러싸서 영역 밖으로 영역을 만들 수 있습니다. 따라서 필요에 따라 비즈니스 규칙을 사용하여 영역을 표시할 수 있습니다. 기본적으로 영역은 항상 표시됩니다. 선택 사항인 검색 및 패싯 매개 변수를 사용하여 해당 영역과 연관된 검색 또는 패싯을 표시할 수 있습니다. 이러한 기능을 사용하면 영역이 숨겨져 있을 때 검색 또는 패싯을 생략할 수 있으므로 검색 시간 성능이 향상됩니다. 높이 및 너비 속성은 선택 사항이며 영역을 제거할 때 시각적 규칙 빌더에 자리 표시자가 표시되는 방식을 구성하는 데 사용됩니다. </p> <p> 가능한 영역 대신 <span class="codeph"> 도우미-if-facet[-not]-visible </span> 태그를 사용하십시오. 프레젠테이션 템플릿을 단순화합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-if-zone gsname="zone area"&gt; &lt;guided-else-zone&gt; &lt;/guided-if-zone&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그 집합을 사용하면 영역이 현재 표시되어 있는 경우 테스트할 수 있습니다. 영역이 표시될 때만 표시할 컨텐츠가 페이지의 다른 곳에 있을 때 유용합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
이러한 루프 블록에서 다음 루프 표시기를 각각 사용할 수 있습니다.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이 조건은 현재 반복이 루프의 마지막 반복일 때 적용됩니다. 이것이 반드시 마지막 결과나 마지막 페이지를 의미하지는 않지만, 현재 컨텍스트(페이지)에 마지막으로 표시된 것을 의미합니다. 사이트 방문자가 200개의 결과를 포함하는 결과 세트의 1페이지에 있지만 페이지당 결과가 10개밖에 없는 경우 마지막 반복은 결과 200이 아닌 결과 10입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> 
   ...
   <td colname="col2"> <p>이 조건은 현재 반복이 루프의 홀수 이터레이션인 경우(짝수 이터레이션과 비교) 적용됩니다. 다양한 행 색상을 표시하는 데 유용합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <code> &lt;guided-if[-not]-even&gt;&lt;guided-else[-not]-even&gt; 
      &lt;/guided-if[-not]-even&gt; </code> </p> </td> 
   <td colname="col2"> <p>이 조건은 현재 반복이 루프의 짝수 반복인 경우(홀수 이터레이션과 비교) 적용됩니다. 다양한 행 색상을 표시하는 데 유용합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   <td colname="col1"> <p> <code> &lt;guided-if[-not]-alt&gt;&lt;guided-else[-not]-alt&gt; 
      &lt;/guided-if[-not]-alt&gt; </code> </p> </td> 
   <td colname="col2"> <p>이 조건은 현재 반복이 루프의 짝수 반복일 때 적용됩니다. 다양한 행 색상을 표시하는 데 유용합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> <code> &lt;guided-if[-not]-inner&gt;&lt;guided-else[-not]-inner&gt; 
      &lt;/guided-if[-not]-inner&gt; </code> </p> </td> 
   <td colname="col2"> <p>현재 이터레이션이 첫 번째 또는 마지막 버전이 아닌 경우 두 항목 사이의 텍스트를 포함합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>사용되는 현재 경로를 제공합니다. 일반적으로 기존 검색에 새 매개 변수를 추가하는 링크를 만드는 데 사용됩니다. 기본적으로 경로는 URL 이스케이프됩니다. escape 매개 변수를 통해 사용할 이스케이프 모드를 지정할 수 있습니다. </p> <p>예: </p> <p> <code class="syntax html"> &lt;a&nbsp;href="&lt;guided-current-path&nbsp;/&gt;&amp;lang=fr"&gt; 
      French&nbsp;Version </code> </p> <p>이 예에서 검색 처리 규칙은 lang을 사용하여 프랑스어 버전을 선택합니다. </p> <p>현재 경로에는 항상 하나 이상의 쿼리 매개 변수가 있습니다. 다른 쿼리 매개 변수가 없는 경우 q=*로 설정되므로 매개 변수를 더 쉽게 추가할 수 <span class="codeph"> </span> 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> 기본 경로 </span> </p> </td> 
   <td colname="col2"> <p> basepath를 사용하여 링크를 만들려면 href의 시작 <span class="codeph"> 에 /를 사용하고 매개 변수 </span> <span class="codeph"> </span> 에 추가하십시오. </p> <p> <code class="syntax html"> &lt;a&nbsp;href="/"&gt;All&nbsp;Products&lt;/a&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>URL에 있는 쿼리 매개 변수의 기존 값을 가져올 수 있습니다. 매개 변수가 없으면 이 태그는 빈 문자열을 반환합니다. escape 옵션을 지정하지 않으면 반환된 문자열이 자동으로 HTML escape됩니다. HTML 또는 URL escape 중 하나를 지정할 수 있습니다. </p> <p>예: </p> <p> 

    &amp;lt;guided-query-param&amp;nbsp;gsname=&quot;q&amp;nbsp;/&amp;gt;nbsp;
    값&amp;nbsp;nbsp;value&amp;nbsp;nbsp;dps
    
    &amp;nbsp;nbsp;dsp;;get;
    gies&amp;nbsp;nbsp;value&amp;nbsp;nbsp;value&amp;nbsp;en
    
    &amp;lt;guided-query-param&amp;nbsp;gsname=&quot;test&quot;&amp;nbsp;/&amp;
    gsname;nbsp;/&amp;nbsp;nbsp&amp;n;string
    &amp;nbsp;nbsp;
    &amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&lt;/code> &lt;/p> &lt;/td>
</tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Guided Search는 탐색 표시 컨트롤에 사용되는 쿼리 번호의 개념을 가지고 있습니다. <span class="codeph"> guided-query-param-name </span> 을 사용하면 안내 검색을 통해 올바른 쿼리 번호를 계산하는 프레젠테이션 템플릿의 링크의 일부로 매개 변수를 정의할 수 있습니다. gsname <span class="codeph"> </span> 에 "x"가 있으며, 검색 안내 기능이 올바른 숫자로 바뀝니다. 오프셋 값은 0 - 15일 수 있습니다. 여기서 0은 사용 가능한 다음 쿼리 번호가 사용됨을 나타냅니다. 1은 1을 추가하려는 경우등을 나타냅니다. </p> <p>안내 <span class="codeph"> 현재 패스와 함께 자신만의 미니 패싯 </span>링크를 만들거나 추가 드릴다운 수준을 허용할 수 있습니다. </p> <p>예: </p> <p> <code class="syntax html"> &lt;a&nbsp;href="&lt;guided-current-path 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 다른 템플릿 파일을 포함할 수 있습니다. 이 기능은 하위 템플릿을 모듈로 사용하여 여러 템플릿을 만들 수 있음을 의미합니다. </p> <p>다음 예에서 탐색 표시 <span class="filepath"> 및 </span> 패싯 <span class="filepath"> </span> 파일이 포함됩니다. </p> <p> <code class="syntax html"> &lt;guided-include&nbsp;gsfile='breadcrumbs.tmpl'&nbsp;/&gt; 
      &lt;guided-include&nbsp;gsfile='facets.tmpl'&nbsp;/&gt; </code> </p> <p>동적 포함은 지원되지 않습니다. 즉, gsfile은 <span class="codeph"> 변수가 </span> 될 수 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 검색 결과 페이지를 작성하는 데 사용되는 코어 검색 횟수를 반환합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>8 </p> </td> 
   <td colname="col1"> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>초기 검색에 있는지 여부를 확인할 수 있습니다(쿼리는 검색 상자의 검색 결과임). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>14 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-search-url/&gt; </span> </p> </td> 
   <td colname="col2"> <p>템플릿에서 이 태그를 사용하여 검색 양식의 작업을 하드코딩하지 않아도 됩니다. 스테이지 또는 라이브 환경에 있는 시간을 감지하고 그에 따라 변경됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>15 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>템플릿을 구동하는 검색 안내 엔진은 엔진이 생성하는 각 새로운 링크가 다음 사용 가능한 쿼리 번호를 사용하는 부동 쿼리 번호에 대한 개념을 갖습니다. 이 태그를 사용하면 다음 쿼리 번호나 오프셋을 가져올 수 있으므로 결과 세트로 드릴다운하는 사용자 지정 링크를 만들 수 있습니다. 오프셋을 사용하면 다음 쿼리 번호로 오프셋할 수 있습니다. 예를 들어 하나의 패싯을 선택한 경우 다음 쿼리 번호는 2이고 오프셋은 1이고 반환된 쿼리 번호는 3입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>17 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-custom-var gsname="custom_variable" [escape="html|url|json|0"]/&gt; </span> </p> </td> 
   <td colname="col2"> <p>처리 규칙이 정의하는 사용자 지정 변수의 기존 값을 선택할 수 있도록 해줍니다. escape 옵션을 지정하지 않으면 반환된 문자열이 자동으로 HTML escape됩니다. html, <span class="codeph"> url </span><span class="codeph"> , js </span>또는 <span class="codeph"> </span><span class="codeph"> </span>0을 지정할 수 있습니다. 처리 규칙을 사용하여 들어오는 CGI 매개 변수를 사용자 지정 변수에 복사한 다음, escape가 none 또는 js로 설정된 템플릿에 해당 변수를 표시하거나 사용하는 경우, 검색에서 XSS 취약점을 만들 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>18 </p> </td> 
   ...
   <td colname="col2"> <p>사용자 지정 변수가 처리 규칙(쿼리 정리, 사전 검색 처리 및 사후 검색 처리)에 정의된 경우 테스트를 활성화합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>19 </p> </td> 
   ...
   <td colname="col2"> <p>전송 템플릿에서 정의된 일반 필드의 내용을 표시할 수 있습니다. escape 옵션을 지정하지 않으면 반환된 문자열이 해당 필드의 전송 템플릿에서 지정한 형식으로 인코딩됩니다. 이스케이프 옵션 지정은 전송 템플릿에서처럼 필드를 인코딩하는 형식 위에 적용됩니다. html, JS, JS, JS, URL <span class="codeph"> 을 지정할 수 </span>있습니다. 단, JSON, URL <span class="codeph"> </span><span class="codeph"> </span><span class="codeph"> </span><span class="codeph"> </span>또는 URL을 지정할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>20 </p> </td> 
   ...
   <td colname="col2"> <p>전송 템플릿에 정의된 일반 필드의 내용이 있는지 여부를 테스트할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>21 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-cookie-value gsname="cookie_name" [escape="html|url|json|0"]/&gt; </span> </p> </td> 
   <td colname="col2"> <p>쿠키를 사용할 수 있다고 가정할 때 쿠키의 값을 선택할 수 있습니다. escape 옵션을 지정하지 않으면 반환된 문자열이 자동으로 HTML이 됩니다. <span class="codeph"> html, URL </span>, <span class="codeph"> escape JS, JSON </span>또는 <span class="codeph"> 를 지정할 수 </span><span class="codeph"> </span><span class="codeph"> </span>있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>22 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>지정된 영역에 대한 배너를 출력합니다. 시각적 규칙 빌더에서 선택적인 폭 및 높이 속성은 의미 있는 자리 표시자를 표시하여 사용자가 배너를 선택할 수 있도록 하는 데 사용됩니다. 기본적으로 배너는 이스케이프되지 않습니다. 대신 HTML을 프레젠테이션 템플릿에 삽입해야 합니다. 그러나 JSON 템플릿을 빌드하는 경우 js escape 옵션 사용을 고려해 보십시오. </p> <p>예: </p> <p> <code class="syntax html"> &lt;guided-banner&nbsp;gsname="top"&nbsp;width="400px" 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Target <span class="keyword"> </span> 캠페인을 참조하는 비즈니스 규칙이 있는지 탐지할 수 있습니다. Adobe Target은가 필요 없을 때 Target <span class="keyword"> 서버 </span> 를 히트하지 않도록 하기 위해 일반적으로 <span class="keyword"> </span> 와의 통합의 일부로 사용되기도 한다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>27 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>결과 세트에서 리디렉션을 반환하도록 사이트 검색/머천다이징을 구성한 경우 이 태그 집합을 사용하여 출력으로의 리디렉션이 있는지 여부를 확인할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>29 </p> </td> 
...
프레젠테이션 레이어에는 여러 검색 결과를 보여주는 단일 프레젠테이션 템플릿이 있을 수 있습니다. 각 검색은 동일한 전송 템플릿 또는 사용자 지정 전송 템플릿을 사용하여 데이터를 프레젠테이션 레이어로 전달할 수 있습니다.

전송 템플릿은 프레젠테이션 레이어로 데이터를 전달하는 데만 사용되므로 검색 결과를 표시하는 데 관련된 HTML은 없습니다. 전송 템플릿은 전송 템플릿 XML 태그를 사용하여 패싯, 탐색 표시 및 메뉴와 같은 검색 구성 요소를 채우는 검색 결과를 전달합니다. 이러한 태그 내의 표준 검색 템플릿 태그는 실제 값을 표시하는 데 사용됩니다.

프레젠테이션 [또는 전송 템플릿 편집을 참조하십시오](../c-about-design-menu/c-about-templates.md#task_800E0E2265C34C028C92FEB5A1243EC3).

템플릿 [태그 검색을 참조하십시오](../c-appendices/c-templates.md#reference_F7AA3FF602314E42842BBC740D2CA1A4).
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>프레젠테이션 레이어에서 전송 템플릿에서 구문 분석되는 항목을 검색하는 데 사용하는 루트 XML 태그입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> &lt;일반&gt;&lt;/general&gt; </span> </p> </td> 
   <td colname="col2"> <p>결과 세트를 기반으로 요약 데이터를 제공하는 태그 서라운드 검색 템플릿 태그 일반적으로 이러한 태그에는 총 결과 수, 낮은 결과 및 가장 높은 결과에 대한 검색 태그가 포함됩니다. 다음 예제와 같이 <span class="codeph"> 일반 필드 </span> 태그로 원하는 추가 글로벌 필드를 정의할 수 있습니다. </p> <p> <code class="syntax html"> &lt;general&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>태그가 검색 결과에 둘러싸여져 검색 위치를 안내하는 검색입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> &lt;result&gt;&lt;/result&gt; </span> </p> </td> 
   <td colname="col2"> <p>태그는 각 검색 결과에 둘러싸여 있으므로, 다음 예제와 같이 검색 결과 중 하나의 컨텐츠가 시작되고 끝나는 위치를 검색 결과 내에서 인식합니다. </p> <code class="syntax html"> &lt;results&gt; 
     &nbsp;&nbsp;&lt;search-results&gt; 
     &nbsp;&nbsp;&nbsp;&nbsp;&lt;result&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>단일 결과를 위해 다중 값 목록의 각 항목을 루프할 수 있습니다. 결과 내에서만 이 태그를 사용하십시오. 이 항목의 목적은 다음 예제와 같이 결과 필드에 속하는 속성을 반복하도록 하는 것입니다. </p> <code class="syntax html"> &lt;results&gt; 
     &nbsp;&nbsp;&lt;search-results&gt; 
     &nbsp;&nbsp;&nbsp;&nbsp;&lt;result&gt; 
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;index&gt;&lt;search-index&nbsp;/&gt;&lt;/index&gt; 
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;loc&gt;&lt;search-url&nbsp;/&gt;&lt;/loc&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 패싯을 동적 패싯과 패싯 레일의 구성원으로 지정할 수 있습니다. 그러나 관련 프레젠테이션 템플릿 태그와 관련하여 이러한 매개 변수의 치료 방식은 독립적으로 처리됩니다. </p> <p>즉, 동적 패싯 반복 컨텍스트 내에 패싯 레일 반복 컨텍스트의 중첩은 허용되지 않습니다. </p> <p>동적 패싯과 레일에 모두 포함된 패싯의 경우, 지정된 검색에 대해 반환된 동적 패싯만 패싯 레일 반복 컨텍스트 내에 표시됩니다. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 각 패싯에는 이름 매개 변수가 패싯 이름과 일치하는 자체 패싯 태그가 있습니다. 다음 예와 같이 검색 태그는 패싯 값에 대한 패싯 태그 내에 사용됩니다. </p> <code class="syntax html"> &lt;facets&gt; 
     ...
     &nbsp;&nbsp;&lt;/facet&gt; 
     &lt;/facets&gt; </code> <p> 연결된 패싯을 사용하는 계정은 다이내믹 태그 및 표시 이름 태그를 사용할 수 있습니다. 이러한 태그는 모두 비즈니스 규칙을 만드는 동안 단면화 및 실제 단면화 간의 매핑을 용이하게 하는 데 도움이 됩니다. </p> <code class="syntax html"> &lt;facets&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 추천 메시지를 태그로 래핑하여 검색 안내 기능에서 제안이 포함된 XML 노드를 인식할 수 있도록 합니다. </p> <p><a href="../c-about-linguistics-menu/c-about-did-you-mean.md#concept_7D4F3C29EF184B538B8AE2ECAE0CDC5E" type="concept" format="dita" scope="local">다음을 찾으려고 하셨습니까? 정보</a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> &lt;추천&gt;&lt;/propose&gt; </span> </p> </td> 
   <td colname="col2"> <p>다음 예제와 같이 각 제안을 태그로 둘러싸십시오. </p> <code class="syntax html"> &lt;search-if-suggestions&gt; 
     &nbsp;&nbsp;&lt;suggestions&gt; 
     &nbsp;&nbsp;&nbsp;&nbsp;&lt;search-suggestions&gt; 
...
* [XML 템플릿에 문자 집합 지정](../c-appendices/c-templates.md#section_17DC31CDCC104F5F8081466B41A96E9D)
...
결과 루프 태그는 템플릿 시스템의 작업 공간입니다. 검색 중에 태그가 발견되면 HTML이 반복되고 시작 및 종료 결과 루프 태그 사이에 다른 태그가 추가되어 다른 태그를 검색 결과로 바꿉니다.
...
결과 [루프 태그 정보를 참조하십시오](../c-appendices/c-templates.md#section_D4DC7B4560144663972E8DBC3369C629).
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>현재 결과의 점수를 반환합니다(숫자 0 - 100). [ <span class="uicontrol"> 옵션] </span> &gt; [ <span class="uicontrol"> 메타데이터] </span> &gt; <span class="uicontrol"> 정의] 아래에 등급 필드를 정의하면 등급 속성 동적( </span><span class="codeph"> </span>&lt;search-score rank="dynamic")을 설정하여 동적 페이지 등급을 표시할 수 있습니다. 등급 특성을 정적( <span class="codeph"> &lt;search-score rank="static"&gt;)으로 설정하여 정적 페이지 등급을 표시할 수 </span>있습니다. 선택적 정밀도 속성을 사용하여 표시할 소수점 자릿수를 지정할 수 있습니다. 기본값은 0으로 정수 점수를 표시합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   ...
   <td colname="col2"> <p>현재 결과의 날짜를 반환합니다. 현재 결과와 연관된 날짜가 없는 경우 선택적 "없음" 텍스트 값이 표시됩니다. 선택 사항인 "없음" 값을 지정하지 않으면 현재 결과와 연관된 날짜가 없는 경우 "날짜 없음" 텍스트가 표시됩니다. </p> <p>"date-format" 속성은 "%A, %B %d, %Y"(2016년 7월 25일) 등의 UNIX 스타일 날짜 형식 문자열을 가져옵니다. "gmt"의 기본값은 "yes"로 설정되며 날짜 문자열의 시간 부분이 GMT("yes")로 출력되어야 하는지 또는 계정의 표준 시간대("no")로 출력되어야 하는지 여부를 제어합니다. </p> <p>"language" 속성은 출력 날짜 문자열의 언어 및 로케일 규칙을 제어합니다. "0"(기본값)은 "계정 언어 사용"을 의미합니다. "2"라 함은 "문서 언어 사용"을 의미합니다. "language" 값 "1"은 나중에 사용하도록 예약되어 있습니다. 기타 모든 "언어" 값은 특정 언어 식별자로 해석됩니다. 예를 들어 "en_US"는 "영어(미국)"를 의미합니다. </p> <p>선택적 length 속성은 표시된 문자열의 길이를 80자로 제한하는 데 사용됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>현재 결과의 URL을 반환합니다. </p> <p>선택적 <span class="codeph"> length </span> 속성을 사용하여 표시된 문자열의 길이를 제한(기본값: 제한 없음)합니다. </p> <p>인코딩 <span class="codeph"> </span> 속성은 선택 사항이며 HTML 인코딩, Javascript 인코딩, Perl 인코딩 또는 none으로 출력 문자를 인코딩할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>검색어에 대한 다음 컨텍스트 행을 반환합니다. 관련 용어는 굵게 표시됩니다. 현재 결과에 대해 두 개 이상의 컨텍스트 라인을 표시하려면 이 태그를 반복적으로 호출합니다. </p> <p>선택적 <span class="codeph"> length </span> 속성을 사용하여 표시된 문자열의 길이를 80자로 제한합니다. length 속성을 포함하는 &lt;search-if-context&gt; <span class="codeph"> 또는 </span> &lt;search-if-any-context&gt; <span class="codeph"> 태그 세트로 이 태그를 둘러싸면 length </span> <span class="codeph"> </span> 속성이 무시됩니다. </p> <p>인코딩 <span class="codeph"> </span> 속성은 선택 사항이며 HTML 인코딩(기본값), Javascript 인코딩, Perl 인코딩 또는 none으로 출력 문자를 인코딩할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>11 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field name="field-name" length="XX" none="text" date-format="date-format-string" gmt="yes/no" language="0/2/language-id" encoding="html/javascript/json/perl/url/none" quotes="yes/no" unps="miles/km" separator="|"&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 고급 태그는 현재 결과에 대해 이름 <span class="uicontrol"> 속성에 지정된 메타데이터 필드(url, 제목, 설명, 키, 대상, 본문, 대체, 날짜, 문자, 문자 집합 및 언어 또는 [옵션] </span> &gt; [ <span class="uicontrol"> 메타데이터 </span> &gt; 정의]에 정의된 필드)의 내용 <span class="codeph"> </span> 을 표시합니다. 예: </p> <p> <span class="codeph"> &lt;search-display-field name="title" length="70" none="no title"&gt; </span> </p> <p>검색 결과에 대한 페이지 제목을 출력합니다. 선택 사항 <span class="codeph"> 없음 </span> 속성이 지정된 경우 해당 값은 필드와 연관된 컨텐츠가 없는 경우에만 결과 페이지에 표시됩니다. </p> <p>날짜 형식, <span class="codeph"> gmt </span>및 <span class="codeph"> 언어 </span> 속성은 지정된 필드의 컨텐츠 유형이 <span class="codeph"> </span> <span class="codeph"> </span>날짜-인 경우에만 관련이 있습니다. </p> <p>date- <span class="codeph"> format </span> 속성은 <span class="codeph"> %A, %B %d, %Y와 같은 UNIX 스타일 날짜 형식 문자열(2016년 7월 25일 </span> 의 경우)을 가져옵니다. <span class="codeph"> gmt </span> 는 기본적으로 <span class="codeph"> yes </span> 로 설정되며 날짜 문자열의 시간 부분이 GMT( <span class="codeph"> 예)로 출력되는지 아니면 계정의 표준 시간대( </span>아니요)로 출력되는지를 제어합니다 <span class="codeph"> </span>. </p> <p>날짜 <a href="../c-appendices/c-templates.md#section_4BBDBBEF2B96414497617CD4B52D96E4" type="section" format="dita" scope="local"> 형식 문자열을 참조하십시오</a>. </p> <p>언어 <span class="codeph"> </span> 속성은 출력 날짜 문자열의 언어 및 로케일 규칙을 제어합니다. <span class="codeph"> 0 </span> (기본값)은 "계정 언어 사용"을 의미합니다. <span class="codeph"> 2 </span> 는 "문서 언어 사용"을 의미합니다. 언어 값 <span class="codeph"> 1 </span> <span class="codeph"> </span> 은 나중에 사용하도록 예약되어 있습니다.) 다른 모든 <span class="codeph"> 언어 </span> 값은 특정 언어 식별자로 해석됩니다. 예를 들어, <span class="codeph"> en_US는 "영어(미국)" </span> 를 의미합니다. </p> <p>언어 <a href="../c-appendices/c-templates.md#section_0490DECC00E34691ADE5A9ED90A6D911" type="section" format="dita" scope="local"> 식별자를 참조하십시오</a>. </p> <p>선택적 <span class="codeph"> length </span> 속성은 표시된 문자열의 길이를 80자로 제한하는 데 사용됩니다. </p> <p>선택적 <span class="codeph"> 인코딩 </span> 속성은 결과 페이지에서 출력하기 위해 출력이 HTML 인코딩, JavaScript 인코딩, Perl 인코딩, URL 인코딩 또는 인코딩되지 않았는지 여부를 제어합니다. 인코딩의 기본값은 <span class="codeph"> html </span> 입니다 <span class="codeph"> </span>. 일반적으로 인코딩 특성을 지정할 필요가 없습니다. </p> <p>선택적 <span class="codeph"> 따옴표 </span> 속성은 개별 항목 출력이 큰따옴표(encoding=perl인 경우 작은따옴표)로 둘러싸여 있는지 여부를 제어합니다 <span class="codeph"> </span>. 따옴표 <span class="codeph"> 기본값은 [아니요] </span><span class="codeph"> 입니다 </span>. </p> <p>선택적 <span class="codeph"> 쉼표 </span> 속성은 개별 항목 출력을 쉼표로 구분할지 여부를 제어합니다. 쉼표 <span class="codeph"> 의 기본값은 </span> yes <span class="codeph"> 입니다 </span>. 비목록 유형 필드에 대해서는 <span class="codeph"> 쉼표 </span> 속성이 무시됩니다. </p> <p>선택적 <span class="codeph"> 단위 </span> 속성은 근접 검색 출력 필드에 적용된 거리 단위를 제어합니다. 단위의 기본값은 주어진 근접 검색 출력 필드와 관련된 위치 유형 필드의 "기본 단위" 설정 <span class="codeph"> </span> 에서 결정됩니다. </p> <p>근접 검색 <a href="../c-appendices/r-about-proximity-search.md#reference_45AC6BB50609431ABD31DA46EE65360D" type="reference" format="dita" scope="local"> 정보를 참조하십시오</a>. </p> <p>선택적 <span class="codeph"> 구분 </span> 속성은 목록 유형 필드의 출력 값 사이에 삽입되는 단일 문자 또는 구분 기호를 정의합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>12 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field-values name="field-name"&gt;...&lt;search-display-field-values&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 현재 결과에 대한 메타데이터 필드 값(url, 제목, 설명, 키, 대상, 본문, 대체, 날짜, 문자, 문자, 언어 또는 [옵션] <span class="uicontrol"> &gt; [ </span> 메타데이터 <span class="uicontrol"> &gt; </span> 정의] <span class="uicontrol"> </span>)을 열거하는 루프를 만듭니다. 이 태그를 다른 <span class="codeph"> &lt;search-display-field-values&gt; </span> 태그 내에 중첩하지 마십시오. name <span class="codeph"> </span> 속성은 열거할 값이 들어 있는 필드의 이름을 지정합니다. 이 태그는 [옵션] &gt; [메타데이터] <span class="uicontrol"> &gt; [ </span> 정의]에서 허용 목록 <span class="uicontrol"> 속성 </span> 을 선택한 필드 <span class="uicontrol"> 에 가장 </span> <span class="uicontrol"> </span>유용합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>13 </p> </td> 
   ...
   <td colname="col2"> <p>이 태그는 현재 <span class="uicontrol"> &lt;search-display-field-values&gt; 루프에 대한 메타데이터 필드 값(url, title, desc, 키, 대상, 본문, 대체, 대체, 날짜, 차트, 문자, 언어 또는 필드 </span> 가 [메타데이터 옵션] &gt; [메타데이터 <span class="uicontrol"></span> 정의]에 정의된 필드 <span class="uicontrol"> </span><span class="codeph"> </span> )을 출력합니다. 이 태그는 <span class="codeph"> &lt;search-display-field-values&gt; </span> 루프 내에서만 유효합니다. 날짜 형식, <span class="codeph"> gmt 언어 </span>속성은 바깥쪽 &lt;search-display-field-values&gt; 태그에 지정된 필드 이름 <span class="codeph"> 의 컨텐트 유형이일 경우에만 관련성이 </span> <span class="codeph"> </span> <span class="codeph"> </span> <span class="codeph"> </span>있습니다. 날짜 형식 <span class="codeph"> 속성은 </span> " A, % <span class="codeph"> % </span>%d %d <span class="codeph"> , %d은(는) %N입니다.의 경우 </span> <span class="codeph"> </span><span class="codeph"> </span>%Monday, 2016년 7월 25일")와 같은 UNIX 스타일 날짜 문자열을 가져옵니다. gmt <span class="codeph"> 속성은 기본적으로 yes로 설정되며 날짜 문자열의 시간 부분이 GMT( </span> 예) 또는 계정의 표준 시간대( <span class="codeph"> </span> <span class="codeph"> </span><span class="codeph"> </span>아니요)로 출력되는지 여부를 제어합니다. </p> <p>언어 <span class="codeph"> </span> 속성은 출력 날짜 문자열의 언어 및 로케일 규칙을 제어합니다. <span class="codeph"> 0 </span> (기본값)은 "계정 언어 사용"을 의미합니다. 다른 모든 <span class="codeph"> 언어 </span> 값은 특정 언어 식별자로 해석됩니다. 예를 들어, <span class="codeph"> en_US는 "영어(미국)" </span> 를 의미합니다. </p> <p>선택적 <span class="codeph"> 인코딩 </span> 속성은 결과 페이지에서 출력하기 위해 출력이 HTML 인코딩, JavaScript 인코딩, Perl 인코딩, URL 인코딩 또는 인코딩되지 않았는지 여부를 제어합니다. 인코딩의 기본값은 <span class="codeph"> html </span> 입니다 <span class="codeph"> </span>. 일반적으로 인코딩 특성을 지정할 필요가 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>14 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field-value-count name="field-name"&gt; </span> </p> </td> 
   <td colname="col2"> <p>이름 특성으로 지정된 메타데이터 필드(url, 제목, 설명, 키, 대상, 본문, 대체, 날짜, 문자, 언어 및 [옵션] <span class="uicontrol"> &gt; [ </span> 메타데이터 <span class="uicontrol"> &gt; </span> 정의]에 정의된 필드)에 대한 현재 결과의 총 값 수 <span class="uicontrol"> </span>를 출력합니다. 이 태그는 결과 루프의 어디에나 나타날 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>15 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field-value-counter&gt; </span> </p> </td> 
   <td colname="col2"> <p>현재 <span class="codeph"> &lt;search-display-field-values&gt; 루프 반복에 대한 서수 카운터(1, 2, 3 등)를 </span> 출력합니다. 이 태그는 <span class="codeph"> &lt;search-display-field-values&gt; </span> 루프 내에서만 유효합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>16 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>결과 위치에 영향을 준 결과 기반 작업 등 현재 결과의 배치와 관련된 정보를 출력합니다. </p> <p>이 태그의 출력 형식은 다음 예와 같이 JSON입니다. </p> <p> <code> { 
    ...
    <!--<p> Results added to the results set by way of <codeph>rbta</codeph> have a "naturalPosition" value of -1. </p>--> <p>인코딩 <span class="codeph"> </span> 속성은 선택 사항입니다.기본값은 html입니다 <span class="codeph"> </span>. </p> <p> <p>참고: 이 태그는 핵심 검색 쿼리 매개 변수와 함께 <span class="codeph"> sp_trace=1 </span> 을 지정한 경우에만 출력됩니다. </p> </p> <p>백 엔드 검색 CGI 매개 변수에 있는 표에서 48행을 <a href="../c-appendices/c-cgiparameters.md#reference_582E85C3886740C98FE88CA9DF7918E8" format="dita" scope="local"> 참조하십시오</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
다음 태그에는 두 태그 사이의 HTML이 조건부로 포함됩니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이러한 태그에는 <span class="codeph"> &lt;search-title&gt;에 대한 다음 호출이 문서 제목에서 텍스트를 반환하거나 반환하지 않을 경우 그 사이에 HTML이 </span> 포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p> 다음 호출에서 <span class="codeph"> &lt;search-description&gt;을 </span> 호출하면 문서 설명의 텍스트가 반환되거나 반환되지 않는 경우 이러한 태그에는 해당 사이에 HTML이 포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   ...
   <td colname="col2"> <p>이러한 태그에는 <span class="codeph"> &lt;search-bodytext&gt;에 대한 다음 호출이 문서 본문에서 텍스트를 반환하거나 반환하지 않을 경우 그 사이에 HTML이 </span> 포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   ...
   <td colname="col2"> <p>이러한 태그에는 <span class="codeph"> &lt;search-context&gt;에 대한 다음 호출이 비어 있지 않은 컨텍스트 문자열을 반환하거나 반환하지 않을 경우 </span> 그 사이에 HTML이 포함됩니다. length 속성은 <span class="codeph"> 동봉된 &lt;search-context&gt; </span> 태그의 length 속성을 무시합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   ...
   <td colname="col2"> <p>이러한 태그에는 결과와 연관된 컨텍스트 문자열이 있거나 없는 경우 태그 사이에 HTML이 포함됩니다. length 속성은 <span class="codeph"> 동봉된 &lt;search-context&gt; </span> 태그의 length 속성을 무시합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if-score lower="XX" upper="yy" rank="dynamic/static/dynamic-raw/static-raw/final-raw"&gt; .. &lt;/search-if-score&gt; </span> </p> <p> <span class="codeph"> &lt;search-if-not-score lower=XX upper=yrank="dynamic/static"&gt; .. &lt;/search-if-not-score&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그에는 현재 결과의 점수가 XX와 YY 사이에 있거나 없는 경우 이 태그 사이에 HTML이 포함됩니다. 글머리 기호나 그래픽을 추가하여 결과의 연관성을 보여주는 데 유용합니다. [옵션] <span class="uicontrol"> &gt; [ </span> 메타데이터] &gt; [정의]에서 등급 유형 필드 <span class="uicontrol"> 를 정의한 경우, 등급 속성을 동적( </span> <span class="uicontrol"> </span><span class="codeph"> </span>&lt;search-if-score="dynamic" lower=XX upper=YY&gt;)으로 설정하여 동적 페이지 등급을 확인할 수 있습니다. 등급 특성을 정적( <span class="codeph"> &lt;search-if-score="static" lower=XX upper=YY&gt;)으로 설정하여 정적 페이지 등급을 확인할 수 </span>있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   ...
   <td colname="col2"> <p>이러한 고급 태그에는 "name" 속성에 지정된 필드에 컨텐츠가 있는지 여부를 기준으로 그 사이에 HTML이 포함됩니다. 선택적 "value" 속성이 지정된 경우, 태그에는 주어진 값이 현재 결과의 필드 값과 일치하는지(또는 일치하지 않음) 여부를 기준으로 그 사이에 HTML이 포함됩니다. 이러한 태그는 결과 루프( <span class="codeph"> &lt;search-results&gt; </span> 와 <span class="codeph"> &lt;/search-results&gt; </span> 태그 사이)에서만 작동합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이 태그 쌍은 태그 사이의 HTML 주위에 앵커 링크를 만듭니다. 링크를 클릭하면 결과 페이지가 표시됩니다. 선택적 target 속성은 프레임 지원 브라우저가 결과 페이지를 표시하는 명명된 창을 지정합니다. </p> <p>HBX을 통해 사용 가능한 분석을 활용하려면 hbox-enable 속성을 "yes"로 설정합니다. hbox-linkid-name을 추적할 메타 데이터 필드의 이름으로 설정합니다. 예를 들어 SKU 번호로 검색 결과를 추적하려면 hbox-linkid-name을 SKU 정보가 포함된 메타 데이터 필드의 이름으로 설정합니다. </p> <p>현재 날짜 유형 필드는 지원되지 않습니다. hbox-linkid-name의 값이 생성된 앵커의 링크 ID에 추가됩니다. 이름이 지정된 메타 데이터 필드가 비어 있을 때마다 hbx-linkid-none 속성의 값이 링크 ID에 추가됩니다. hbox-linkid-length 값은 메타 태그에 반입되고 표시되는 문자 수를 제한합니다. 기본 문자 수는 12자입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p>이 태그 쌍은 <span class="codeph"> &lt;search-link&gt; ... &lt;/search-link&gt; </span> 태그와 유사합니다. 생성된 앵커 링크를 클릭하면 결과 페이지가 표시되지만, 가장 가까운 앵커 태그로 결과 앞에 페이지가 스크롤되었습니다. PDF 링크의 경우 Acrobat 뷰어에 결과가 포함된 페이지가 표시됩니다. 선택적 target 속성은 프레임 지원 브라우저가 결과 페이지를 표시하는 명명된 창을 지정합니다. </p> <p>HBX을 통해 사용 가능한 분석을 활용하려면 hbox-enable 속성을 "yes"로 설정합니다. hbox-linkid-name을 추적할 메타 데이터 필드의 이름으로 설정합니다. 예를 들어 SKU 번호로 검색 결과를 추적하려면 hbox-linkid-name을 SKU 정보가 포함된 메타 데이터 필드의 이름으로 설정합니다. </p> <p>현재 날짜 유형 필드는 지원되지 않습니다. hbox-linkid-name의 값이 생성된 앵커의 링크 ID에 추가됩니다. 이름이 지정된 메타 데이터 필드가 비어 있을 때마다 hbx-linkid-none 속성의 값이 링크 ID에 추가됩니다. hbox-linkid-length 값은 메타 태그에 반입되고 표시되는 문자 수를 제한합니다. 기본 문자 수는 12자입니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   ...
   <td colname="col2"> <p>값 특성이 결과에 대한 URL의 끝과 일치하는 확장자를 지정하는 경우 이러한 태그에는 그 사이에 HTML이 포함됩니다. 이 태그는 링크 확장명을 기반으로 검색 결과에 그래픽을 포함하는 데 유용합니다. value 속성은 다음과 같이 하나 이상의 확장(공백으로 구분) 목록입니다.VALUE=".pdf" 또는 VALUE=".html .htm". </p> </td> 
  </tr> 
 </tbody> 
</table>
...
다음 태그에는 두 태그 사이의 텍스트가 조건부로 포함됩니다. &quot;반복&quot; 태그 내에만 표시될 수 있습니다.&lt; `search-results>` 및 `<search-field-values>`. 결과 집합 내의 현재 결과의 위치를 테스트하는 데 사용됩니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>이 태그에는 현재 결과가 페이지의 첫 번째 결과( <span class="codeph"> &lt;search-results&gt; 내에서 사용될 경우) </span>또는 첫 번째 필드 값( <span class="codeph"> &lt;search-field-values&gt; 내에서 사용될 경우)인 경우 두 필드 사이에 있는 텍스트가 </span>포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p>이 태그에는 현재 결과가 페이지의 마지막 결과( <span class="codeph"> &lt;search-results&gt; 내에서 사용될 경우) </span>또는 마지막 필드 값( <span class="codeph"> &lt;search-field-values&gt; 내에서 사용될 경우)인 경우 이 </span>사이에 있는 텍스트가포함됩니다. 이 태그는 결과 사이에 구분 기호를 삽입하는 데 사용할 수 있습니다. 예를 들어 결과 사이에 <span class="codeph"> &lt;hr&gt; </span> 태그가 삽입됩니다. </p> <p> <code class="syntax html"> &lt;search-results&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>현재 결과가 페이지의 첫 번째 또는 마지막 결과가 아니거나( <span class="codeph"> &lt;search-results&gt; 내에서 사용될 때) 첫 번째 또는 마지막 필드 값이 아닌 경우(&lt;search-field-values&gt; 내에서 사용될 경우), 이 태그들 사이에 있는 텍스트 </span>가 <span class="codeph"> </span>포함됩니다. 태그 버전이 아닌 경우 결과가 첫 번째인지 마지막 버전인지 테스트합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   ...
   <td colname="col2"> <p>현재 결과가 페이지의 대체 결과이거나(&lt;search-results&gt; 내부에서 사용된 경우) 또는 대체 필드 값(&lt;search-field-values&gt; 내에서 사용되는 경우)인 경우 이 태그들 사이 <span class="codeph"> 의 텍스트가 </span><span class="codeph"> </span>포함됩니다. "대체" 결과는 페이지의 두 번째, 네 번째, 여섯 번째 등입니다. 이 예는 다른 클래스를 대체 테이블 행에 적용합니다. &lt;search-lt&gt; <span class="codeph"> 및 </span> &lt;search-gt&gt; <span class="codeph"> 를 사용하여 </span> &lt;search-if-alt&gt; <span class="codeph"> 태그를 </span> &lt;tr&gt; 태그 내에 " <span class="codeph"> 삽입할 수 있도록 </span> 하십시오. </p> <p> <code class="syntax html"> &nbsp;&nbsp;&nbsp;&nbsp;&lt;search-results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;search-lt&gt;tr&lt;search-if-alt&gt;&nbsp;class="alt"&lt;/search-if-alt&gt;&lt;search-gt&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&gt;&lt;search-url&gt;&lt;/td&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/tr&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/search-results&gt; </code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이러한 태그에는 현재 결과가 짝수 결과(&lt;search-results&gt; 내에서 사용될 경우) <span class="codeph"> 또는 짝수 번호 필드 값(&lt;search-field-values&gt; 내에서 사용될 경우)인 경우 그 사이 </span>의 텍스트가 <span class="codeph"> </span>포함됩니다. 검색 결과는 해당 <span class="codeph"> &lt;search-index&gt; </span> 값이 짝수로 지정된 경우에도 번호가 매겨집니다. 즉, 전체 결과 세트 내의 위치가 짝인 경우 전체 결과 집합 내에서가 아니라 <span class="codeph"> &lt;search-if-alt&gt; </span> 페이지에서 결과의 위치를 테스트하는 경우와 다를 수 있습니다. 다음 두 표는 차이에 대해 설명합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table>  
 <thead> 
  <tr> 
   ...
   <th colname="col3" class="entry"> <p>짝이요? </p> </th> 
...
마지막으로, 필드 값 `<search-if-even>` 이 호출되지 않기 때문에 검색 필드 값 `<search-if-alt>` 에 대한 값과 항상 동일합니다.

## 필드 값 목록 태그 {#section_D3298B5F976447DBA0032B883DCC91B1}

전체 검색 결과 세트의 다음과 같은 고급 태그 출력 필드 값 및 관련 데이터. 이러한 태그는 검색 쿼리의 `sp-sfvl-field` CGI 매개 변수에 의해 지정된 필드에 대해서만 출력합니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colname="col01"> <p>1 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-field-value-list name="field-name" quotes="yes/no" data="values/results" separator="X" sortby="none/values/counts/results" max-items="XX" date-format="date-format-string" gmt="yes/no" language="javasencoding="html/no" cript/json/perl/url/none"&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그에는 전체 결과 세트 내의 고유한 필드 값, 값 수 또는 결과 카운트 목록이 표시됩니다. </p> <p>이 태그는 검색 쿼리에서 <span class="codeph"> sp_sfvl_field </span> CGI 매개 변수에 의해 지정된 필드에 대해서만 출력합니다. 선택적 "quotes" 속성은 개별 항목 출력이 큰따옴표(encoding=perl인 경우 작은따옴표)로 둘러싸여 있는지 여부를 제어합니다. "quotes"의 기본값은 "yes"입니다. 선택적 "쉼표" 속성은 개별 항목 출력을 쉼표로 구분할지 여부를 제어합니다. "쉼표"의 기본값은 "yes"입니다. 선택적 "data" 속성은 각 고유 필드 값이 출력되는지(data="values"), 각 고유 필드 값의 총 개수가 출력되는지(data="counts") 또는 각 고유 값을 포함하는 결과 수(data="results")를 제어합니다. "data"의 기본값은 "values"입니다. 목록이 아닌 필드의 경우 data="counts" 및 data="results"는 같습니다. separator 속성은 출력 값 사이에 삽입될 단일 문자 또는 구분 기호를 정의합니다. 선택적 "정렬" 속성은 출력의 순서를 제어합니다.sortby="none"은 특정 순서를 의미하지 않고, sortby="values"는 필드 값별로 정렬하는 것을 의미하며(필드의 정렬 속성에 따라 오름차순 또는 내림차순), sortby="counts"는 필드 값 카운트의 내림차순으로 정렬하는 것을 의미하며, sortby="results"는 각 값이 들어 있는 결과 수의 내림차순으로 정렬하는 것을 의미합니다. </p> <p>sortby="counts" 및 sortby="results"는 목록이 아닌 필드에 해당합니다. 선택적 "max-items" 속성은 출력할 항목 수를 제한합니다. "max-items"의 기본값은 -1이며, 이것은 "모든 항목 출력"을 의미합니다. </p> <p>최대 항목에 대해서는 절대 제한이 100입니다. "date-format", "gmt" 및 "language" 속성은 지정된 필드의 컨텐츠 유형이 "date"인 경우에만 관련이 있습니다. "date-format" 속성은 "%A, %B %d, %Y"(2016년 7월 25일) 등의 UNIX 스타일 날짜 형식 문자열을 가져옵니다. "gmt"의 기본값은 "yes"로 설정되며 날짜 문자열의 시간 부분이 GMT("yes")로 출력되어야 하는지 또는 계정의 표준 시간대("no")로 출력되어야 하는지 여부를 제어합니다. </p> <p>날짜 <a href="../c-appendices/c-templates.md#section_4BBDBBEF2B96414497617CD4B52D96E4" type="section" format="dita" scope="local"> 형식 문자열을 참조하십시오</a>. </p> <p>"language" 속성은 출력 날짜 문자열의 언어 및 로케일 규칙을 제어합니다. "0"(기본값)은 "계정 언어 사용"을 의미합니다. 기타 모든 "언어" 값은 특정 언어 식별자로 해석됩니다. 예를 들어 "en_US"는 "영어(미국)"를 의미합니다. 선택적 "인코딩" 속성은 출력 문자열 문자가 결과 페이지에서 출력하기 위해 HTML 인코딩, JavaScript 인코딩, Perl 인코딩, URL 인코딩 또는 인코딩되지 않았는지 여부를 제어합니다. "encoding"의 기본값은 "html"입니다. </p> <p>언어 <a href="../c-appendices/c-templates.md#section_0490DECC00E34691ADE5A9ED90A6D911" type="section" format="dita" scope="local"> 식별자를 참조하십시오</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p>이 태그는 지정된 검색 필드-값 목록에 대한 카운트 정보를 표시합니다. 이 태그에는 세 가지 고유한 사용 방식이 있습니다. "name" 속성만 제공되는 경우 이 태그는 전체 결과 집합 내에서 명명된 필드에 대한 고유한 값의 수를 출력합니다. "name" 및 "value" 속성이 모두 제공되면 이 태그는 전체 결과 집합(results="no") 내에서 지정된 값의 총 개수를 출력하거나 전체 결과 집합(results="yes")에 지정된 값을 포함하는 총 결과 수를 출력합니다. "results"의 기본값은 "no"입니다. 참고:목록 유형이 아닌 필드의 경우 results="yes" 및 results="no"는 같습니다. "value" 속성이 제공되지 않으면 "results"의 값이 무시됩니다. 이 태그는 검색 쿼리에서 sp-sfvl-field <span class="codeph"> </span> CGI 매개 변수에 의해 지정된 필드에 대한 출력만 생성합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   ...
   <td colname="col2"> <p>지정된 속성을 사용하여 <span class="codeph"> &lt;search-field-value-list-count name="field-name" value="field-value"&gt;에 대한 상응하는 호출이 0보다 큰 값을 반환하거나 반환하지 않을 경우, 이러한 태그는 그 사이 </span> 의 HTML을 표시합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   ...
   <td colname="col2"> <p>이러한 태그는 지정된 특성을 가진 <span class="codeph"> &lt;search-field-value-list-count name="field-name" value="field-value"&gt;에 대한 </span> 등가 호출로 단일 값을 반환하거나 반환하지 않을 경우 그 사이에 있는 컨텐트를 표시합니다. 이는 일반적으로 계정에서 패싯 슬롯을 사용하는 경우에 사용됩니다. 패싯 슬롯에서는 일반적으로 연결된 이름-슬롯에 단일 항목이 있는 경우에만 값-슬롯을 표시하려고 합니다. 전송 템플릿에서 이 검사를 수행하는 것이 프레젠테이션 레이어에서 수행하는 것보다 더 효율적입니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
다음 고급 태그는 루핑 구문을 사용하여 전체 검색 결과 세트의 필드 값과 관련 데이터를 열거하고 출력합니다. 이러한 태그는 검색 쿼리의 `sp-sfvl-field` CGI 매개 변수에 의해 지정된 필드에 대해서만 출력합니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colname="col01"> <p>1 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-field-values name="field-name" sortby="none/values/results" max-items="XX"&gt; .. &lt;/search-field-values&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 전체 결과 집합 내의 특정 필드에 대한 필드 값과 관련 데이터를 열거하는 루프를 만듭니다. 이 태그를 다른 <span class="codeph"> &lt;search-field-values&gt; </span> 태그 내에 중첩하지 마십시오. "name" 속성은 열거할 값이 포함된 필드의 이름을 지정합니다. 선택적 "정렬" 속성은 열거형 순서를 제어합니다."none"은 특정 순서를 의미하지 않으며, "values"는 필드 값(필드의 정렬 속성에 따라 오름차순 또는 내림차순)으로 정렬하는 것을 의미하며, sortby="counts"는 필드 값 카운트의 내림차순, sortby="results"는 각 값이 들어 있는 결과 수의 내림차순으로 정렬하는 것을 의미합니다. </p> <p>sortby="counts" 및 sortby="results"는 목록이 아닌 필드에 해당합니다.. 선택적 "max-items" 속성은 반복 횟수를 지정된 값으로 제한합니다. "max-items"의 기본값은 -1이며, 이것은 "모든 값 열거"를 의미합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p>이 태그는 현재 &lt;search-field-values&gt; 루프 반복에 대한 필드 값을 출력합니다. 이 태그는 <span class="codeph"> &lt;search-field-values&gt; </span> 루프 내에서만 유효합니다. "date-format", "gmt" 및 "language" 속성은 바깥쪽 &lt;search-field-values&gt; 태그에 지정된 필드 이름의 내용 유형이 "date"인 경우에만 관련이 있습니다. "date-format" 속성은 "%A, %B %d, %Y"(2020년 7월 25일) 등의 UNIX 스타일 날짜 형식 문자열을 가져옵니다. </p> <p>날짜 <a href="../c-appendices/c-templates.md#section_4BBDBBEF2B96414497617CD4B52D96E4" type="section" format="dita" scope="local"> 형식 문자열을 참조하십시오</a>. </p> <p>선택적 "인코딩" 속성은 출력 문자열 문자가 결과 페이지에서 출력하기 위해 HTML 인코딩, JavaScript 인코딩, Perl 인코딩, URL 인코딩 또는 인코딩되지 않았는지 여부를 제어합니다. "encoding"의 기본값은 "none"입니다. 일반적으로 인코딩 특성을 지정할 필요가 없습니다. "gmt"의 기본값은 "yes"로 설정되며 날짜 문자열의 시간 부분이 GMT("yes")로 출력되어야 하는지 또는 계정의 표준 시간대("no")로 출력되어야 하는지 여부를 제어합니다. "language" 속성은 출력 날짜 문자열의 언어 및 로케일 규칙을 제어합니다. "0"(기본값)은 "계정 언어 사용"을 의미합니다. 기타 모든 "언어" 값은 특정 언어 식별자로 해석됩니다. 예를 들어 "en_US"는 "영어(미국)"를 의미합니다. </p> <p>언어 <a href="../c-appendices/c-templates.md#section_0490DECC00E34691ADE5A9ED90A6D911" type="section" format="dita" scope="local"> 식별자를 참조하십시오</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-field-value-count results="yes/no"&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 현재 <span class="codeph"> &lt;search-field-values&gt; </span> 루프 반복과 연관된 카운트를 출력합니다. 출력 개수는 필드 값(results="yes")이 포함된 전체 결과 집합의 결과 수나 전체 결과 집합의 필드 값에 대한 총 계수입니다. "results"의 기본값은 "no"입니다. </p> <p>목록 유형이 아닌 필드의 경우 results="yes" 및 results="no"는 같습니다. 이 태그는 <span class="codeph"> &lt;search-field-values&gt; </span> 루프 내에서만 유효합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-field-value-counter&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 현재 <span class="codeph"> &lt;search-field-values&gt; 루프 반복에 대한 서수 카운터를 </span> 출력합니다. 이 태그는 <span class="codeph"> &lt;search-field-values&gt; </span> 루프 내에서만 유효합니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colname="col01"> <p>1 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if-conquestions&gt;... &lt;/search-if-conquestions&gt; </span> </p> </td> 
   <td colname="col2"> <p>이러한 태그들을 <span class="codeph"> &lt;search-propose&gt;, &lt;search-propose-link&gt; 등과 같은 "추천" 템플릿 태그 </span><span class="codeph"> </span>로 둘러싸십시오. 검색이 제안을 생성하면 검색 엔진은 열린 태그와 닫기 태그 사이의 모든 것을 출력하고 처리합니다. 검색에서 제안을 생성하지 않으면 중첩된 콘텐츠 중 아무 것도 출력되지 않습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-conquestions&gt; ... &lt;/search-conquestions&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 원래 "intelends"로 입력된 질의에 대해 제안된 검색어 목록(예: "intend", "intend" 및 "concept")을 포함하는 "Propose" 루프를 생성합니다. 용어 목록을 생성할 때 검색 엔진은 중첩된 HTML 및/또는 템플릿 태그를 최대 5배까지 반복하며 이것은 최대 제안 수입니다. 카운트 속성을 사용하여 생성된 제안 수를 지정합니다(0-5 사이). </p> <p>&lt; <span class="codeph"> search-progress&gt; </span> 태그는 페이지에 여러 번 표시되어 제안 목록을 반복할 수 있습니다. 여러 제안은 각 수익률 결과에 따라 정렬됩니다. </p> <p>&lt;search- <span class="codeph"> suggestions&gt; </span> 태그 <span class="codeph"> 를 여는 태그와 닫는 태그 사이에 중첩합니다. &lt;search-if-sugends&gt; </span> 태그 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-proposal-link&gt; ... &lt;/search-proposal-link&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 원래 용어 대신 선택한 제안된 검색어를 사용하여 원래 검색 쿼리에 대한 링크를 생성합니다. 태그는 클래스, 대상 및 스타일과 같은 HTML 속성을 수락하고 인쇄하기만 합니다. 태그는 생성된 링크의 기본 URL로 사용되는 URL 속성을 허용할 수도 있습니다. 태그는 <span class="codeph"> &lt;search-consists&gt; </span> 루프 내에만 나타날 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-proposal-text/&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 현재 제안된 쿼리 용어(예: 원래 "intends"로 입력된 쿼리에 대해 "의도적")를 인쇄합니다. 태그에는 특성이 없으며 <span class="codeph"> &lt;search-programs&gt; </span> 루프 내에만 나타날 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if-not-progress&gt; ... &lt;/search-if-not-progress&gt; </span> </p> </td> 
   <td colname="col2"> <p>검색에서 제안을 생성하지 않으면 검색 엔진은 열린 태그와 닫기 태그 사이의 모든 항목을 출력하고 처리합니다. 검색에서 제안 사항이 생성되면 중첩된 콘텐츠 중 아무것도 출력되지 않습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if[-not]-first-propose&gt;.. &lt;/search-if[-not]-first-propose&gt; </span> </p> </td> 
   <td colname="col2"> <p>이러한 조건부 태그에는 제안된 용어가 제안 루프의 첫 번째 용어인지 여부를 기반으로 두 용어 간의 HTML이 포함됩니다. 태그는 열기 및 닫기 <span class="codeph"> &lt;search-propose&gt; </span> 태그 사이에 나타나야 합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if[-not]-last-proposal&gt;... &lt;/search-if[-not]-last-proposal&gt; </span> </p> </td> 
   <td colname="col2"> <p>이러한 조건부 태그에는 제안된 용어가 제안 루프의 마지막 용어인지 여부를 기반으로 두 용어 간의 HTML이 포함됩니다. 태그는 열기 및 닫기 <span class="codeph"> &lt;search-propose&gt; </span> 태그 사이에 나타나야 합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>8 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-proposion-index&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 현재 제안된 검색어의 숫자 인덱스를 반환합니다. 태그는 열기 및 닫기 <span class="codeph"> &lt;search-propose&gt; </span> 태그 사이에 나타나야 합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-proposion-total&gt; </span> </p> </td> 
   <td colname="col2"> <p>이 태그는 제안된 검색어의 총 수를 반환합니다. 태그는 열기 및 닫기 <span class="codeph"> &lt;search-propose&gt; </span> 태그 사이에 나타나야 합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>10 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-proposer-result-count&gt; </span> </p> </td> 
...
다음 태그는 템플릿의 해당 지점에서 HTML로 문자열을 출력합니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>템플릿 링크 아래에 기본 모양 섹션이 설정하는 검색 링크 색상 설정이 있는 HTML 본문 태그입니다. 이 태그에 배경 속성을 추가하여 결과 페이지에 배경 이미지를 표시합니다. 이 태그에 추가된 모든 색상 속성은 기본 Look 섹션이 설정하는 검색 링크 색상 설정을 덮어씁니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>search-data 태그는 다음과 같은 XML 태그로 대체됩니다. <span class="codeph"> &lt;search-data&gt; </span> 이 <span class="codeph"> &lt;![CDATA[" 및 &lt;/search-cdata&gt; </span> 태그는 " <span class="codeph"> ]]&gt; </span>"로 대체됩니다. XML 구문 분석기는 열기 태그와 닫기 태그 사이의 정보를 구문 분석하지 않습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-query-query-number="XX" encoding="html/javascript/json/perl/url/none"&gt; </span> </p> </td> 
   <td colname="col2"> <p>방문자가 입력한 쿼리 고급 선택적 "쿼리 번호" 속성은 번호가 지정된 쿼리 문자열이 이 태그로 출력되는 것을 제어합니다. 예를 들어 <span class="codeph"> &lt;search-query query-number=1&gt; </span> 는 <span class="codeph"> sp_q_1 cgi </span> 매개 변수의 컨텐츠를 출력합니다. "query-number"가 지정되지 않았거나 쿼리 번호가 "0"인 경우 기본 쿼리( <span class="codeph"> sp_q </span>)가 출력됩니다. 선택적 "encoding" 속성은 출력 결과가 결과 페이지에서 출력되도록 HTML 인코딩, JavaScript 인코딩, Perl 인코딩, URL 인코딩 또는 인코딩되지 않았는지 여부를 제어합니다. "encoding"의 기본값은 "html"입니다. 일반적으로 인코딩 특성을 지정할 필요가 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>계정에 대해 구성된 검색 로고의 HTML(있는 경우) 이 로고는 사이트 검색/머천다이징에 크레디트를 제공하는 이미지입니다 </p> <p>현재 대부분의 계정에 연결된 검색 로고가 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>13 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>시작 및 끝 양식 태그를 삽입합니다. 메서드 및 작업 속성을 시작 양식 태그에 삽입합니다. 언어 및 JavaScript 관련 "name" 및 "onSubmit" 속성을 위한 dir="RTL" 속성을 비롯한 추가 속성을 수락합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>15 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>현재 검색 요청에서 "param-name"이라는 cgi 매개 변수의 값을 반환합니다. 선택적 "encoding" 속성은 출력 결과가 결과 페이지에서 출력되도록 HTML 인코딩, JavaScript 인코딩, Perl 인코딩, URL 인코딩 또는 인코딩되지 않았는지 여부를 제어합니다. "encoding"의 기본값은 "html"입니다. 일반적으로 인코딩 특성을 지정할 필요가 없습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>22 </p> </td> 
   <td colname="col1"> <p> 
...
다음은 앵커 링크가 이러한 태그 사이의 HTML을 둘러싸도록 하는 태그입니다. 클릭하면 앵커 링크가 다른 결과 페이지를 표시하도록 요청합니다. 선택적 속성 &quot;count&quot;는 페이지에 많은 결과가 표시되도록 요청합니다. 지정하지 않으면 현재 페이지에서 요청한 카운트가 사용됩니다. 고급 선택적 &quot;URL&quot; 속성은 연결된 링크가 이동하는 도메인을 제어합니다. 기본적으로 도메인은 `https://search.atomz.com/search/`있지만 URL 속성을 사용하여 변경할 수 있습니다.
...
태그 사이에 HTML을 조건부로 포함할 수 있도록 해주는 태그입니다.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이러한 태그에는 이전 페이지나 다음 페이지에 연관된 결과가 있는 경우 HTML이 포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>현재 페이지에서 요약을 표시하거나 숨기는 경우 이러한 태그에는 HTML이 포함됩니다. 이러한 태그를 사용하여 검색 결과의 일부를 포함하거나 제외할 수 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   ...
   <td colname="col2"> <p>현재 페이지의 검색 결과 생성에 컬렉션이 지정된 경우 이러한 태그에는 HTML이 포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   ...
   <td colname="col2"> <p>검색 쿼리에 대해 sp_advanced= <span class="codeph"> 1 CGI </span> 매개 변수가 지정된 경우 이 태그에는 HTML이 포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이러한 고급 태그에는 "name" 속성에 지정된 CGI 매개 변수가 "value" 속성에 지정된 값을 가지고 있는지 여부를 기준으로 그 사이에 있는 HTML이 포함됩니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
...
검색 템플릿의 확인란, 라디오 단추 및 목록 상자에 대한 기본 선택 상태를 제어할 수 `<form>` 있는 태그입니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>&lt;input&gt; 태그 대신 템플릿에 <span class="codeph"> </span> 사용됩니다. 태그가 브라우저에 작성되면 단어 <span class="codeph"> 입력 </span> 이 <span class="codeph"> 검색 입력을 </span> 대체하며 태그에 있는 다른 모든 정보는 그대로 출력됩니다. 또한 태그에 <span class="codeph"> 지정된 </span> 이름이 CGI 매개 변수 <span class="codeph"> 로 나열되고 태그에 </span> 지정된 값이 해당 CGI 매개 변수의 값이면 확인된 단어 <span class="codeph"> 가 태그 끝에 추가됩니다 </span> . 이렇게 하면 검색 결과의 기본 라디오 단추 또는 확인란 상태를 현재 쿼리와 동일하게 자동으로 만들 수 있습니다. </p> <p>예를 들어 확인란을 위한 HTML 코드는 다음과 같이 표시될 수 있습니다. </p> <p> <span class="codeph"> &lt;input type=checkbox name="sp_w" value="exact"&gt;유사한 사운드 일치 없음 </span> </p> <p>해당 확인란을 위한 해당 템플릿 코드는 다음과 같습니다. </p> <p> <span class="codeph"> &lt;search-input type=checkbox name="sp_w" value="exact"&gt;유사한 사운드 일치 없음 </span> </p> <p>쿼리에 대한 CGI 매개 변수 문자열에 <span class="codeph"> sp_w=exact </span>가 있는 경우 검색 결과가 있는 브라우저에 기록된 태그는 다음과 같이 표시됩니다(선택한 단어 <span class="codeph"> </span> 는 태그 끝에 삽입됨). </p> <p> <span class="codeph"> &lt;input type=checkbox name="sp_w" value="exact" checked&gt;유사한 사운드 일치 없음 </span> </p> <p>쿼리에 대한 CGI 매개 변수 문자열에 <span class="codeph"> sp_w=exact </span>가 없으면 검색 결과가 있는 브라우저에 기록된 태그는 다음과 같습니다(선택한 단어 <span class="codeph"> </span> 는 태그에 나열되지 않음). </p> <p> <span class="codeph"> &lt;input type=checkbox name="sp_w" value="exact"&gt;유사한 사운드 일치 없음 </span> </p> <p>&lt;search-input&gt; <span class="codeph"> </span> 태그는 검색 템플릿에 확인란 및 라디오 단추를 넣는 데 유용합니다. 검색 템플릿에서 <span class="codeph"> &lt;form&gt; </span> 에 추가하려는 확인란 또는 라디오 단추가 있는 경우 <span class="codeph"> &lt;input....&gt; </span> 대신 <span class="codeph"> &lt;search-input..&gt; </span>을 사용합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p>&lt;form&gt; 태그의 <span class="codeph"> 드롭다운 목록 상자 </span> 는 <span class="codeph"> &lt;select&gt; </span> 태그로 시작되어 <span class="codeph"> &lt;/select&gt; </span> 태그로 끝납니다. 연결된 CGI 매개 변수 <span class="codeph"> 의 </span> 이름은 <span class="codeph"> &lt;select&gt; </span> 태그 내에 나열되어 있습니다. &lt; <span class="codeph"> select&gt; </span> 태그 뒤에는 <span class="codeph"> 목록 상자 내에 표시할 값을 지정하는 &lt;option&gt; </span> 태그의 목록이 있습니다. </p> <p>&lt; <span class="codeph"> -select&gt;, &lt;/search-select&gt;, </span>&lt;search-option&gt; <span class="codeph"> 및 &lt;search-option&gt; </span><span class="codeph"> </span><span class="codeph"> </span> <span class="codeph"> </span> 태그는 &lt;search-input&gt; 태그에 비슷한 기능을 제공합니다. 즉, 선택한 단어 <span class="codeph"> 는 &lt;option&gt; 끝 </span> 에 자동으로 추가되어 &lt;option&gt;의 이름 <span class="codeph"> 이 CGI 매개 변수로 나열되고 CGI 매개 변수 </span> 의 값이 특정 검색 옵션 &lt;search-option&gt;의 값으로 나열된CGI 매개 변수 <span class="codeph"> 값이 특정 검색 옵션 </span> <span class="codeph"> </span> <span class="codeph"> </span> <span class="codeph"> </span> <span class="codeph"> </span> 의 값으로 지정된 경우 브라우저로 전송됩니다. 이렇게 하면 검색 결과에서 현재 쿼리와 동일한 기본 목록 상자를 자동으로 선택할 수 있습니다. </p> <p>예를 들어 일반적인 목록 상자는 다음과 같습니다. </p> <p> <code class="syntax html"> &lt;select&nbsp;name="sp_x"&nbsp;size=1&gt; 
      ...
      &lt;/select&gt; </code> </p> <p>해당 목록 상자에 해당하는 템플릿 코드는 다음과 같습니다. </p> <p> <code class="syntax html"> &lt;search-select&nbsp;name="sp_x"&nbsp;size=1&gt; 
      ...
      &lt;/search-select&gt; </code> </p> <p>검색 템플릿에서 &lt; <span class="codeph"> form&gt; </span> 에 추가하려는 목록이 있는 경우 <span class="codeph"> &lt;search-select...&gt; </span> 자리 <span class="codeph"> 에서 &lt;select.&gt;를 사용하십시오. &lt;select..&gt; </span>를 선택합니다. &lt;를 선택한 다음, &lt;를 선택하십시오.&gt;. &lt;를 선택하십시오.&gt;. &lt;를 선택한 <span class="codeph"> Vertising Place의 Search-Option &lt;를 사용합니다. &lt;를 선택하면 &lt;를 검색할 수 있습니다.&gt;. &lt;를 선택하면 &lt;를 선택하면 &lt;를 클릭하면 &lt;를 검색하십시오.&gt; &lt;를 선택하면 &lt;를 </span> &lt;를 선택하면 &lt;를 선택하면 &lt;새 선택 중인 Vertisplevertising가 새 옵션 &lt; a가 새 옵션가 &lt;.&gt;. &lt;를 <span class="codeph"></span><span class="codeph"> </span> <span class="codeph"> </span><span class="codeph"> </span> <span class="codeph"> </span>Vertiser-Vertiser-toVertiser-VertisingVertisingVertisingVertising가 &lt;. &lt;를 &lt;.&gt;. &lt;. &lt;.&gt;. &lt;를 선택합니다.&gt;.&gt;.&gt;. &lt;를 사용합니다.&gt;.&gt;.&gt;.&gt;. &lt;를 선택합니다. &lt;를 /option&gt; </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-sort-by-field name="field-name" count="XX"&gt; .. &lt;/search-sort-by-field&gt; </span> </p> </td> 
   <td colname="col2"> <p>이러한 고급 태그는 이러한 태그 사이의 HTML 주위에 앵커 링크를 만듭니다. 이 앵커를 클릭하면 지정된 필드에 정렬된 결과 페이지가 표시됩니다. 선택적 <span class="codeph"> 카운트 </span> 속성은 결과 페이지에 표시할 결과 수를 지정합니다. 카운트 <span class="codeph"> </span> 를 생략하면 현재 페이지에 사용된 카운트가 사용됩니다. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
날짜 형식 문자열에서 다음 전환 사양을 사용할 수 있습니다.
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> "월요일"과 같이 전체 평일 이름의 전국적 표현과 일치합니다. 언어학 <span class="uicontrol"> &gt; </span> 단어 및 언어 <span class="uicontrol"> &gt; 언어 </span> 의 설정은 국가 <span class="uicontrol"> 표현을 </span> 결정합니다. </p> <p>단어 <a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local"> 및 언어 정보를 참조하십시오</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%a </p> </td> 
   <td colname="col2"> <p> 약어가 처음 3자(예: "Mon")인 평일 이름의 약어와 일치합니다. 언어학 <span class="uicontrol"> &gt; </span> 단어 및 언어 <span class="uicontrol"> &gt; 언어 </span> 의 설정은 국가 <span class="uicontrol"> 표현을 </span> 결정합니다. </p> <p>단어 <a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local"> 및 언어 정보를 참조하십시오</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%B </p> </td> 
   <td colname="col2"> <p> 전체 월 이름의 국가 표현(예: "June")과 일치합니다. 언어학 <span class="uicontrol"> &gt; </span> 단어 및 언어 <span class="uicontrol"> &gt; 언어 </span> 의 설정은 국가 <span class="uicontrol"> 표현을 </span> 결정합니다. </p> <p>단어 <a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local"> 및 언어 정보를 참조하십시오</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%b </p> </td> 
   <td colname="col2"> <p> 축약된 월 이름의 국가 표현(예: "Jun")과 일치합니다. 언어학 <span class="uicontrol"> &gt; </span> 단어 및 언어 <span class="uicontrol"> &gt; 언어 </span> 의 설정은 국가 <span class="uicontrol"> 표현을 </span> 결정합니다. </p> <p>단어 <a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local"> 및 언어 정보를 참조하십시오</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 월의 날짜를 십진수(1-31)로 찾습니다. 공백이 한 자리 앞에 있습니다. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>%h </p> </td> 
   <td colname="col2"> <p> 축약된 월 이름의 국가 표현과 일치합니다. 여기서 약어는 처음 세 문자입니다(예: "Jun"(예: %b과 같음). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 연도의 날짜를 소수(001-366)로 찾습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%k </p> </td> 
   <td colname="col2"> <p> (24시간 시계를 소수(0-23)로 찾습니다. 공백이 한 자리 앞에 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%l </p> </td> 
   <td colname="col2"> <p> 12시간 시간을 소수점 숫자(1-12)로 찾습니다. 공백이 한 자리 앞에 있습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%M </p> </td> 
   <td colname="col2"> <p> 분을 소수점 숫자(00-59)로 찾습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%m </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> "PM"과 같이 "ANTE" 또는 "post meridiem"의 국가 표현과 일치합니다. 언어학 <span class="uicontrol"> &gt; </span> 단어 및 언어 <span class="uicontrol"> &gt; 언어 </span> 의 설정은 국가 <span class="uicontrol"> 표현을 </span> 결정합니다. </p> <p>단어 <a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local"> 및 언어 정보를 참조하십시오</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> "2013"과 같이 세기가 있는 연도를 십진수 값으로 일치합니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%y </p> </td> 
...
다음 표는 지원되는 각 언어에 대한 언어 식별자를 포함합니다. 다음 템플릿 태그에서 선택적 &quot;language&quot; 속성의 값으로 이러한 식별자를 사용할 수 있습니다.

* `search-date` 및 `search-display-field`.

   결과 [루프 문자열 태그를 참조하십시오](../c-appendices/c-templates.md#section_80D68334E8D04A33937A6E58ABAAA320).
...
및 `content` 속성은 선택 `charset` 사항입니다. 이 태그는 템플릿에 가능한 한 빨리 나타나야 합니다. 또한 이 태그는 해당 태그의 동작에 영향을 주므로 `<search-html-meta-charset>` 또는 `<search-xml-decl>`앞에 나타나는 것이 좋습니다.

속성을 지정하지 않으면 `content` 값의 `MIME-type` 기본값은 **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** 에서 설정된 값으로 설정됩니다 **[!UICONTROL Content Types]**. 속성을 지정하는 `content` 경우, 태그의 기본 `content` 속성으로 `<search-html-meta-charset>` 사용됩니다.

속성을 지정하지 않으면 `charset``charset` 값이 `content-type` 헤더에 기록되지 않습니다.

지정하는 `charset="1"` 경우 실제 값 `charset-name` 은 CGI 매개 변수의 `sp_f` 값입니다. 검색과 함께 `sp_f` CGI 매개 변수가 제출되지 않으면 계정 설정에서 실제 값 `charset-name` 을 읽습니다. > **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**&#x200B;아래에서 계정과 연결된 문자 집합을 보거나 변경할 수 있습니다.

개인 [사용자 정보 구성을 참조하십시오](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6).

특정 문자 집합 이름을 `charset` 값(예: `charset="iso-8859-1"` 또는 `charset="Shift-JIS"`)으로 나열하여 선택할 수 있습니다.

속성을 지정하는 경우 `charset` 속성 `charset` 은 `<search-html-meta-charset>` 및 태그의 기본 `<search-xml-decl>` 속성뿐만 아니라 `content-type` 헤더로 출력됩니다.
...
컨텐츠와 charset 속성은 선택 사항입니다. 이 태그는 템플릿의 HTML `<head>` 섹션에 나타나야 합니다. 이 태그는 템플릿에서 생성된 HTML 페이지의 다음 태그를 생성합니다.

`<meta http-equiv="content-type" content="MIME-type; charset=charset-name">`

content 속성을 지정하지 않으면 실제 값의 기본값이 두 값 중 하나로 `MIME-type` 설정됩니다. 태그에서 `<search-content-type-header>` 속성을 지정한 경우 `content` 해당 값이 사용됩니다. 그렇지 않은 경우 사용된 값은 **[!UICONTROL Templates]** > **[!UICONTROL Settings]** > **[!UICONTROL Content Type]** 탭에서 설정된 값입니다.

속성을 지정하지 않으면 `charset` 실제 값의 기본값이 두 값 중 하나로 `charset-name` 설정됩니다. 태그에서 `<search-content-type-header>` 속성을 지정한 경우 `charset` 해당 값이 사용됩니다. 그렇지 않으면 계정 설정에서 실제 값 `charset-name` 을 읽습니다. > **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**&#x200B;아래에서 계정과 연결된 문자 집합을 보거나 변경할 수 있습니다.

개인 [사용자 정보 구성을 참조하십시오](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6).

지정하는 `charset="1"` 경우 실제 값 `charset-name` 은 CGI 매개 변수의 `sp_f` 값입니다. 검색과 함께 `sp_f` CGI 매개 변수가 제출되지 않는 경우, 실제 값 `charset-name` 은 지정된 경우 `<search-content-type-header>` 태그에 설정된 값 또는 계정 설정에 설정된 값입니다.

처럼 특정 문자 집합 이름을 지정할 수 있습니다 `charset="charset-name"`. 예를 들어, `charset="iso-8859-1"` 또는 `charset="Shift-JIS"`.

태그는 `<search-html-meta-charset>` 선택 사항입니다. 이 값을 제거하면 브라우저는 다음에 대해 기본값을 `content-type`사용합니다. `content="text/html; charset=ISO-8859-1"`. 태그를 자신의 태그로 대체하도록 선택할 수도 `<search-html-meta-charset>` `http-equiv` 있습니다.

## XML 템플릿에 문자 집합 지정 {#section_17DC31CDCC104F5F8081466B41A96E9D}

기본 XML 검색 결과 템플릿은 다음 태그를 통해 현재 계정과 연결된 문자 집합을 지정합니다.

`<search-xml-decl [charset="charset-name"]>`

속성은 `charset` 선택 사항입니다. 이 태그는 템플릿의 맨 위에 표시되어야 하지만 태그 뒤에는 `<search-content-type-header>` 표시됩니다. 이 태그는 템플릿에서 생성된 XML 문서에서 다음 태그를 생성합니다.

`<?xml version="1.0" encoding="charset-name" standalone="yes" ?>`

이 값을 지정하지 않으면 실제 값 `charset`이 기본적으로 두 값 중 하나로 `charset-name` 설정됩니다. 속성을 `<search-content-type-header>` 지정하면 해당 `charset` 값이 사용됩니다. 그렇지 않으면 계정 설정에서 실제 값 `charset-name` 을 읽습니다. > **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**&#x200B;아래에서 계정과 연결된 문자 집합을 보거나 변경할 수 있습니다.

개인 [사용자 정보 구성을 참조하십시오](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6).

지정하는 `charset="1"` 경우 실제 값 `charset-name` 은 CGI 매개 변수의 `sp_f` 값입니다. 검색과 함께 `sp_f` CGI 매개 변수가 제출되지 않는 경우, 실제 값 `charset-name` 은 지정된 경우 `<search-content-type-header>` 태그에 설정된 값 또는 계정 설정에 설정된 값입니다.

원할 경우 특정 문자 집합 이름 `charset="charset-name"`을 지정할 수 있습니다. 예, `charset="iso-8859-1" or charset="Shift-JIS"`.

태그를 `<search-xml-decl>` 자신의 `?xml` 태그로 바꾸도록 선택할 수 있습니다.

## 다른 검색 템플릿 포함 {#section_7D1FCD3D9E2340C291E354C9720E8BC0}

하나의 검색 템플릿을 다른 템플릿에 포함하려면 다음 예제와 같이 파일 속성을 포함할 템플릿 파일의 이름으로 설정하여 `<search-include>` 태그를 사용합니다.

`<search-include file="seo/seo_search_title.tpl" />`

SEO 검색 템플릿 세그먼트는 하위 `seo/` 폴더에 있고 일반 검색 템플릿은 `templates/` 하위 폴더에 있습니다. .tpl 파일만 이 컨텍스트에 포함할 수 있습니다.

## 웹 사이트에 사용할 여러 전송 템플릿 관리 {#reference_12AAB3B9F4C74C11956F1DBA95714C2F}
...
이러한 유형의 검색 기능을 수행하려면 사이트 검색/머천다이징에서 전송 템플릿을 관리할 수 있습니다. 또는 게시에서 전송 템플릿을 관리할 수 있습니다. 사이트 검색/머천다이징과 같이 게시를 사용하면 여러 검색 전송 템플릿을 편집하고 미리 보고 게시할 수 있습니다.

특정 전송 템플릿(기본값 제외)을 사용하도록 검색 양식을 설정하려면 `sp_t` 쿼리 매개 변수를 사용하십시오. 예를 들어 웹 사이트의 표시된 판매 영역에 대해 &quot;clearance&quot;라는 검색 템플릿이 있다고 가정합니다. 다음과 같은 추가 양식 코드와 함께 표준 HTML 검색 양식을 사용합니다.
