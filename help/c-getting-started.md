...
Search&amp;Promote 및 동적 탐색을 처음 사용하는 경우 여기에서 시작하여 계정을 사용하여 실행합니다. 무엇보다도 웹 사이트를 색인화하고 검색 결과의 모양과 느낌을 사용자 정의하는 방법을 배웁니다.

## 계정 {#section_FD4C71A422BD4ACEA51AFC98CDD3211C} 구성

계정을 사용자 지정하기 전에 처음에 할당된 암호를 변경하십시오.

[로그인 암호 변경](c-about-settings-menu/c-about-my-profile-menu.md#task_F5FF13AAD1514FE997C8882D4537C0C9)을 참조하십시오.

문자 집합 인코딩, 연락처 정보, 이메일 주소, 기본 설정 등의 개인 설정도 추가하거나 편집해야 합니다.
...
개인 설정을 마쳤으면 계정 전체 설정을 엽니다.

[계정 설정 구성](c-about-settings-menu/c-about-account-options-menu.md#task_80A38D0C8E4F453395BD67B81E4B45D9)을 참조하십시오.

계정 이름과 웹 사이트 주소를 검토한 다음 보고서 및 예약에 사용할 시간대를 선택합니다. 입력하는 웹 사이트 주소는 사이트의 기본 사이트 &quot;시작 지점&quot;입니다. 시작 지점 아래의 모든 페이지는 직접 또는 간접적으로 지정된 URL에 연결되어 있는 경우 크롤링 및 인덱싱됩니다. 예를 들어 시작 지점이 `https://www.mysite.com/`인 경우 페이지 `https://www.mysite.com/news/04.html`이 기본 `index.html` 페이지나 해당 인덱스에서 연결된 페이지에서 연결되어 있으면 인덱싱됩니다. 웹 사이트에 두 번째 도메인의 페이지와 같이 기본 시작 지점에서 연결되지 않은 섹션이 포함되어 있는 경우 추가 URL 시작 지점을 지정할 수 있습니다.
...
검색 양식을 표시할 위치에 코드를 복사하여 웹 페이지에 붙여넣습니다. 예를 들어, 많은 웹 사이트에서 홈 페이지 또는 탐색 프레임에 양식을 배치합니다. 디자인 및 컨텐츠 요구에 맞게 양식 코드를 편집하거나 검색 매개 변수를 추가로 추가할 수 있습니다.

## 검색 결과 링크 {#section_0B4E2D6E1A3E4D3FBDBB607260CDB111} 사용자 지정
...
색인](c-about-index-menu/c-about-remote-control-for-indexing.md#task_57C296258404448DA7A5ADC9B7232391)에 대한 [원격 제어 구성을 참조하십시오.

## 검색어 보고서 보기 {#section_1F4A7F57B9C64FBDA5E3E592621BF6F4}

방문자의 검색 쿼리가 기록되고 일별, 주별 및 월별로 보고서가 만들어집니다. 이러한 쿼리를 통해 고객이 원하는 항목, 고객 성공 빈도 및 웹 사이트 탐색이 중단되는 위치를 확인할 수 있습니다.

[용어 보고서 보기 또는 Null 검색어 보고서 보기...를 참조하십시오.](c-about-reports-menu/c-about-reports-menu.md#task_53B7ED1582DD4B0E8376546A7AFC789A).

## 검색 경험 {#section_036286EC316F47C89D0D50C2D061BB59} 사용자 지정을 위한 고급 작업

고객의 검색 경험을 맞춤화하고 제어할 수 있는 다양한 추가 옵션이 있습니다.

* URL 마스크로 사이트 중 어떤 부분이 인덱싱되어 있는지, 그리고 어떤 부분이 인덱싱되어 있는지 제어합니다.
...
* 날짜를 기준으로 파일을 포함하거나 제외합니다.
   ...
   [날짜 마스크 정보](c-about-settings-menu/c-about-crawling-menu.md#concept_F4F1F58A646F4A86B8650EC46FDCEF66)를 참조하십시오.
* 웹 사이트에 PDF 문서 또는 MP3 파일 또는 Microsoft Office 파일과 같은 다른 컨텐츠 유형의 파일이 포함된 경우 해당 파일을 색인화하거나 색인화하지 않도록 선택할 수 있습니다.

   [콘텐트 유형 정보](c-about-settings-menu/c-about-crawling-menu.md#concept_6FEA1355C0374500B4C53090C34A8A07)를 참조하십시오.
* 또한 사이트 검색/머천다이징이 검색을 위해 웹사이트의 암호로 보호된 영역에 액세스할 수 있도록 암호를 제공할 수도 있습니다.

   [암호](c-about-settings-menu/c-about-crawling-menu.md#concept_3EDBD731725D46B891F834D4472774DC) 정보를 참조하십시오.
* 웹 사이트를 색인화하는 데 사용되는 연결 수를 제어합니다.

   [연결 정보](c-about-settings-menu/c-about-crawling-menu.md#concept_E2F3B7E7521147479E5948A94BB3A40B)를 참조하십시오.
* 크롤링 및 제출할 양식에 대한 정보를 제공합니다.

   [양식 제출 정보](c-about-settings-menu/c-about-crawling-menu.md#concept_CADD5D7CF373497DAA6F8564D7BC8502)를 참조하십시오.
* 검색에서 &quot;a&quot; 또는 &quot;a&quot;와 같은 일반 단어를 제외합니다.

   [제외된 단어 정보](c-about-linguistics-menu/c-about-excluded-words.md#concept_9DB67BD2F0DC43AC88741003D9F39812)를 참조하십시오.
...
* 템플릿을 내부적으로 테스트할 때 사용할 값을 지정합니다.
   ...
   [미리 보기](c-about-settings-menu/c-about-searching-menu.md#concept_DF293FD3B02C467F8842C8C21D62F294) 정보를 참조하십시오.
...
* 사전 정의된 필드의 내용을 변경합니다. 예를 들어 &quot;On Sale Now!&quot;와 같은 새 컨텐츠를 추가할 수 있습니다. 를 페이지 또는 페이지 그룹의 `desc` 메타 태그로 채웁니다. 또는 실제 웹 페이지를 변경하지 않고도 관련 없는 컨텐츠를 제거할 수 있습니다.

   [주입 정보](c-about-settings-menu/c-about-metadata-menu.md#concept_DA091920671948A0A893A26B3A2FAAE5)를 참조하십시오.

* 페이지 컨텐츠를 인덱싱하기 전에 &quot;다시 작성&quot;하려면 **[!UICONTROL Settings]** > **[!UICONTROL Filtering]** 및 **[!UICONTROL Settings]** > **[!UICONTROL Rewrite Rules]** 아래의 옵션을 사용합니다.
